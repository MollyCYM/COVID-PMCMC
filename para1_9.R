...
init_list <- list(k=3,gamma=3,sigma=sqrt(0.003))
...
write.csv(bi_lst,"../data/para1_model9.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y9.csv")
...
write.csv(plot_df,"../data/para1_beta9.csv")
...
write.csv(fitS,"../data/para1_S9.csv")
...
write.csv(fitE,"../data/para1_E9.csv")
...
write.csv(fitI,"../data/para1_I9.csv")
...
write.csv(fitR,"../data/para1_R9.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha9.csv")
write.csv(1/bi_lst$gamma$value,"../data/para1_gamma9.csv")
write.csv(bi_lst$sigma$value,"../data/para1_sigma9.csv")
