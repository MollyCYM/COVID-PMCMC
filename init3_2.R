...
write.csv(bi_lst,"../data/init3_model2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init3_y2.csv")
...
write.csv(plot_df,"../data/init3_beta2.csv")
...
write.csv(plot_df1,"../data/init3_beta02.csv")
...
write.csv(fitmu,"../data/init3_mu2.csv")
...
write.csv(fitS,"../data/init3_S2.csv")
...
write.csv(fitE,"../data/init3_E2.csv")
...
write.csv(fitI,"../data/init3_I2.csv")
...
write.csv(fitR,"../data/init3_R2.csv")

write.csv(1/bi_lst$k$value,"../data/init3_alpha2.csv")
write.csv(1/bi_lst$gamma$value,"../data/init3_gamma2.csv")
write.csv(bi_lst$sigma$value,"../data/init3_sigma2.csv")
write.csv(bi_lst$theta$value,"../data/init3_theta2.csv")
