...
write.csv(fitY,"../data/para55_y21.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x21.csv")
...
write.csv(fitS,"../data/para55_S21.csv")
...
write.csv(fitE,"../data/para55_E21.csv")
...
write.csv(fitI,"../data/para55_I21.csv")
...
write.csv(fitR,"../data/para55_R21.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik21.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha21.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma21.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma21.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau21.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta21.csv")
write.csv(bi_lst$a$value,"../data/para55_a21.csv")
write.csv(bi_lst$b$value,"../data/para55_b21.csv")