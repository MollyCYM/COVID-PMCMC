...
write.csv(bi_lst,"../data/para2_model2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para2_y2.csv")
...
write.csv(plot_df,"../data/para2_beta2.csv")
...
write.csv(fitS,"../data/para2_S2.csv")
...
write.csv(fitE,"../data/para2_E2.csv")
...
write.csv(fitI,"../data/para2_I2.csv")
...
write.csv(fitR,"../data/para2_R2.csv")

write.csv(1/bi_lst$k$value,"../data/para2_alpha2.csv")
