...
bi <- sample(bi_model, end_time = end_time, input = input_lst, obs = obs_lst, nsamples = 1000, nparticles = minParticles, nthreads = ncores, proposal = 'prior',seed=012311) %>% 
...
write.csv(bi_lst,"../data/Exp4_model1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp4_y1.csv")
...
write.csv(plot_df,"../data/Exp4_beta1.csv")
...
write.csv(plot_df1,"../data/Exp4_beta01.csv")
...
write.csv(fitS,"../data/Exp4_S1.csv")
...
write.csv(fitE,"../data/Exp4_E1.csv")
...
write.csv(fitI,"../data/Exp4_I1.csv")
...
write.csv(fitR,"../data/Exp4_R1.csv")


write.csv(1/bi_lst$k$value,"../data/Exp4_alpha1.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp4_gamma1.csv")
