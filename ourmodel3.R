...
write.csv(plot_df,"427covidbeta.csv")
...
write.csv(plot_df1,"427covidbeta1.csv")
write.csv(bi_lst$k$value,"427covidpalpha.csv")
write.csv(1/bi_lst$k$value,"427covidalpha.csv")
write.csv(bi_lst$gamma$value,"427covidpgamma.csv")
write.csv(1/bi_lst$gamma$value,"427covidgamma.csv")
