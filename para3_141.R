...
init_list <- list(gamma=1.08, k=1.59)
...
write.csv(bi_lst,"../data/para3_model141.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y141.csv")
...
write.csv(plot_df,"../data/para3_beta141.csv")
...
write.csv(fitS,"../data/para3_S141.csv")
...
write.csv(fitE,"../data/para3_E141.csv")
...
write.csv(fitI,"../data/para3_I141.csv")
...
write.csv(fitR,"../data/para3_R141.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha141.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma141.csv")
