...
gen_ode_model <- function(rep_time = 200, ori_seed = 2023, tims = 365, 
 ...
 H1N1BM <- function(time, current_state, params){
  ...
  for (rep_i in 1:rep_time) {
    ...
    k = rtruncnorm(1, a=0, b=Inf, mean = 2, sd = 0.02)
    gamma = rtruncnorm(1, a=0, b=Inf, mean = 5, sd = 0.05)
...
gen_ode_model <- function(rep_time = 200, ori_seed = 2023, tims = 365, 
 ...
 H1N1BM <- function(time, current_state, params){
  ...
  for (rep_i in 1:rep_time) {
    ...
    k = rtruncnorm(1, a=0, b=Inf, mean = 2, sd = 1)
    gamma = rtruncnorm(1, a=0, b=Inf, mean = 5, sd = 1)
...
gen_ode_model <- function(rep_time = 200, ori_seed = 2023, tims = 365, 
 ...
 H1N1BM <- function(time, current_state, params){
  ...
  for (rep_i in 1:rep_time) {
    ...
    k = runif(1, min=1,max=7)
    gamma = runif(1, min=3,max=9)
