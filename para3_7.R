...
write.csv(bi_lst,"../data/para3_model7.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y7.csv")
...
write.csv(plot_df,"../data/para3_beta7.csv")
...
write.csv(fitS,"../data/para3_S7.csv")
...
write.csv(fitE,"../data/para3_E7.csv")
...
write.csv(fitI,"../data/para3_I7.csv")
...
write.csv(fitR,"../data/para3_R7.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha7.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma7.csv")
