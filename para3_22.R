...
write.csv(bi_lst,"../data/para3_model22.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y22.csv")
...
write.csv(plot_df,"../data/para3_beta22.csv")
...
write.csv(fitS,"../data/para3_S22.csv")
...
write.csv(fitE,"../data/para3_E22.csv")
...
write.csv(fitI,"../data/para3_I22.csv")
...
write.csv(fitR,"../data/para3_R22.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha22.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma22.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma22.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau22.csv")
