...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg2_y5w.csv", header=FALSE, stringsAsFactors=FALSE) %>%
  rowSums()
...
write.csv(bi_lst,"../data/para6_model4.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para6_y4.csv")
...
write.csv(plot_df,"../data/para6_beta4.csv")

Mmodel <- read.csv("covidoudg2_model5.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[-1,7]
E<-Mmodel[-1,9]
I<-Mmodel[-1,11]
R<-Mmodel[-1,13]
...
write.csv(fitS,"../data/para6_S4.csv")
...
write.csv(fitE,"../data/para6_E4.csv")
...
write.csv(fitI,"../data/para6_I4.csv")
...
write.csv(fitR,"../data/para6_R4.csv")


write.csv(1/bi_lst$k$value,"../data/para6_alpha4.csv")
write.csv(1/bi_lst$gamma$value,"../data/para6_gamma4.csv")
write.csv(bi_lst$sigma$value,"../data/para6_sigma4.csv")
write.csv(bi_lst$tau$value,"../data/para6_tau4.csv")
write.csv(bi_lst$theta$value,"../data/para6_theta4.csv")
write.csv(bi_lst$a$value,"../data/para6_a4.csv")
write.csv(bi_lst$b$value,"../data/para6_b4.csv")
write.csv(bi_lst$x0$value,"../data/para6_x04.csv")
