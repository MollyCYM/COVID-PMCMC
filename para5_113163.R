...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg2_y133w.csv", header=FALSE, stringsAsFactors=FALSE) %>%
  rowSums()
...
init_list <- list(k=5, gamma=9, sigma=sqrt(0.004), theta=0.05, b=-0.2)
...
write.csv(bi_lst,"../data/para5_model113163.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y113163.csv")
...
write.csv(plot_df,"../data/para5_beta113163.csv")

Mmodel <- read.csv("covidoudg2_model1233.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[-1,7]
E<-Mmodel[-1,9]
I<-Mmodel[-1,11]
R<-Mmodel[-1,13]
...
write.csv(fitS,"../data/para5_S113163.csv")
...
write.csv(fitE,"../data/para5_E113163.csv")
...
write.csv(fitI,"../data/para5_I113163.csv")
...
write.csv(fitR,"../data/para5_R113163.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha113163.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma113163.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma113163.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta113163.csv")
write.csv(bi_lst$b$value,"../data/para5_b113163.csv")
