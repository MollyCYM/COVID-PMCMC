...
write.csv(bi_lst,"../data/para5_model213422.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y213422.csv")
...
write.csv(plot_df,"../data/para5_beta213422.csv")
...
write.csv(fitS,"../data/para5_S213422.csv")
...
write.csv(fitE,"../data/para5_E213422.csv")
...
write.csv(fitI,"../data/para5_I213422.csv")
...
write.csv(fitR,"../data/para5_R213422.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha213422.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma213422.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma213422.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta213422.csv")
write.csv(bi_lst$a$value,"../data/para5_a213422.csv")
write.csv(bi_lst$b$value,"../data/para5_b213422.csv")
