...
write.csv(bi_lst,"../data/para3_model11.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y11.csv")
...
write.csv(plot_df,"../data/para3_beta11.csv")
...
write.csv(fitS,"../data/para3_S11.csv")
...
write.csv(fitE,"../data/para3_E11.csv")
...
write.csv(fitI,"../data/para3_I11.csv")
...
write.csv(fitR,"../data/para3_R11.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha11.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma11.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma11.csv")
