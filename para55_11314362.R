...
write.csv(fitY,"../data/para55_y11314362.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x11314362.csv")
...
write.csv(fitS,"../data/para55_S11314362.csv")
...
write.csv(fitI,"../data/para55_I11314362.csv")
...
write.csv(fitR,"../data/para55_R11314362.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik11314362.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha11314362.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma11314362.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma11314362.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau11314362.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta11314362.csv")
write.csv(bi_lst$a$value,"../data/para55_a11314362.csv")
write.csv(bi_lst$b$value,"../data/para55_b11314362.csv")
