...
write.csv(bi_lst,"../data/init1_model3.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init1_y3.csv")
...
write.csv(plot_df,"../data/init1_beta3.csv")
...
write.csv(plot_df1,"../data/init1_beta03.csv")
...
write.csv(fitmu,"../data/init1_mu3.csv")
...
write.csv(fitS,"../data/init1_S3.csv")
...
write.csv(fitE,"../data/init1_E3.csv")
...
write.csv(fitI,"../data/init1_I3.csv")
...
write.csv(fitR,"../data/init1_R3.csv")

write.csv(1/bi_lst$k$value,"../data/init1_alpha3.csv")
write.csv(1/bi_lst$gamma$value,"../data/init1_gamma3.csv")
write.csv(bi_lst$sigma$value,"../data/init1_sigma3.csv")
write.csv(bi_lst$theta$value,"../data/init1_theta3.csv")
