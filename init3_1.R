...
init_list <- list(sigma=sqrt(0.004), gamma=5, k=5, theta=0.05, tau=0.8)
...
write.csv(bi_lst,"../data/init3_model1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init3_y1.csv")
...
write.csv(plot_df,"../data/init3_beta1.csv")
...
write.csv(plot_df1,"../data/init3_beta01.csv")
...
write.csv(fitmu,"../data/init3_mu1.csv")
...
write.csv(fitS,"../data/init3_S1.csv")
...
write.csv(fitE,"../data/init3_E1.csv")
...
write.csv(fitI,"../data/init3_I1.csv")
...
write.csv(fitR,"../data/init3_R1.csv")

write.csv(1/bi_lst$k$value,"../data/init3_alpha1.csv")
write.csv(1/bi_lst$gamma$value,"../data/init3_gamma1.csv")
write.csv(bi_lst$sigma$value,"../data/init3_sigma1.csv")
write.csv(bi_lst$theta$value,"../data/init3_theta1.csv")
