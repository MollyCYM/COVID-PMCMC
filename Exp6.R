...
library(rbi.helpers)
# Load the data
v <- read.csv("covidou_daily.csv", header=FALSE, stringsAsFactors=FALSE) 
...
bi <- sample(bi_model, end_time = end_time, input = input_lst, obs = obs_lst, nsamples = 1000, nparticles = minParticles, nthreads = ncores, proposal = 'prior',seed=11111) %>% 
...
write.csv(bi_lst,"../data/Exp6_model1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp6_y1.csv")
...
write.csv(plot_df,"../data/Exp6_beta1.csv")
...
write.csv(plot_df1,"../data/Exp6_beta01.csv")
...
write.csv(fitmu,"../data/Exp6_mu1.csv")
...
write.csv(fitS,"../data/Exp6_S1.csv")
...
write.csv(fitE,"../data/Exp6_E1.csv")
...
write.csv(fitI,"../data/Exp6_I1.csv")
...
write.csv(fitR,"../data/Exp6_R1.csv")

write.csv(1/bi_lst$k$value,"../data/Exp6_alpha1.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp6_gamma1.csv")
write.csv(bi_lst$sigma$value,"../data/Exp6_sigma1.csv")
write.csv(bi_lst$theta$value,"../data/Exp6_theta1.csv")
write.csv(bi_lst$a$value,"../data/Exp6_a1.csv")
write.csv(bi_lst$b$value,"../data/Exp6_b1.csv")
