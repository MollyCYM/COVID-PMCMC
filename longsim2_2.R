...
write.csv(bi_lst, "../data/MSEIR2_2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitM,"../data/MM2_2.csv")

write.csv(bi_lst$sigma$value,"../data/Msigma2_2.csv")
write.csv(bi_lst$gamma$value,"../data/Mgamma2_2.csv")
write.csv(bi_lst$beta$value,"../data/Mbeta2_2.csv")
write.csv(bi_lst$mu$value,"../data/Mmu2_2.csv")
