...
model dureau {
  ...
  sub proposal_parameter {
    sigma ~ log_normal(log(max(sigma, 0)), 0.01)
    gamma ~ log_normal(log(max(gamma,0)), 0.01)
    beta ~ log_normal(log(max(beta,0)), 0.01)
    mu ~ log_normal(log(max(mu,0)),0.001)
...
write.csv(bi_lst, "../data/short2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/short_y2.csv")
...
write.csv(fitS,"../data/short_S2.csv")
...
write.csv(fitE,"../data/short_E2.csv")
...
write.csv(fitI,"../data/short_I2.csv")
...
write.csv(fitR,"../data/short_R2.csv")
...
write.csv(fitM,"../data/short_M2.csv")

write.csv(bi_lst$sigma$value,"../data/short_sigma2.csv")
write.csv(bi_lst$gamma$value,"../data/short_gamma2.csv")
write.csv(bi_lst$beta$value,"../data/short_beta2.csv")
write.csv(bi_lst$mu$value,"../data/short_mu2.csv")
