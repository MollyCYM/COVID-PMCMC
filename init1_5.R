...
bi <- sample(bi_model, end_time = end_time, input = input_lst, init=init_list, obs = obs_lst, nsamples = 1000, nparticles = minParticles, filter= 'lookahead', nthreads = ncores, proposal = 'prior',seed=0121212) %>% 
...
write.csv(bi_lst,"../data/init1_model5.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init1_y5.csv")
...
write.csv(plot_df,"../data/init1_beta5.csv")
...
write.csv(plot_df1,"../data/init1_beta05.csv")
...
write.csv(fitmu,"../data/init1_mu5.csv")
...
write.csv(fitS,"../data/init1_S5.csv")
...
write.csv(fitE,"../data/init1_E5.csv")
...
write.csv(fitI,"../data/init1_I5.csv")
...
write.csv(fitR,"../data/init1_R5.csv")

write.csv(1/bi_lst$k$value,"../data/init1_alpha5.csv")
write.csv(1/bi_lst$gamma$value,"../data/init1_gamma5.csv")
write.csv(bi_lst$sigma$value,"../data/init1_sigma5.csv")
write.csv(bi_lst$theta$value,"../data/init1_theta5.csv")
