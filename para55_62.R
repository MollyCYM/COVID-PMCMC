...
write.csv(fitY,"../data/para55_y62.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x62.csv")
...
write.csv(fitS,"../data/para55_S62.csv")
...
write.csv(fitE,"../data/para55_E62.csv")
...
write.csv(fitI,"../data/para55_I62.csv")
...
write.csv(fitR,"../data/para55_R62.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik62.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha62.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma62.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma62.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta62.csv")
write.csv(bi_lst$a$value,"../data/para55_a62.csv")
write.csv(bi_lst$b$value,"../data/para55_b62.csv")
