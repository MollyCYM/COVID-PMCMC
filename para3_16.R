...
bi <- sample(bi_model, end_time = end_time, input = input_lst,init=init_list, obs = obs_lst, nsamples = 1000, nparticles = minParticles, nthreads = ncores, proposal = 'model',seed=9123) %>% 
...
write.csv(bi_lst,"../data/para3_model16.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y16.csv")
...
write.csv(plot_df,"../data/para3_beta16.csv")
...
write.csv(fitS,"../data/para3_S16.csv")
...
write.csv(fitE,"../data/para3_E16.csv")
...
write.csv(fitI,"../data/para3_I16.csv")
...
write.csv(fitR,"../data/para3_R16.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha16.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma16.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma16.csv")
