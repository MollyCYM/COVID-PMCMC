...
init_list <- list(gamma=6, k=8, tau=0.9)
...
write.csv(bi_lst,"../data/init2_model4.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init2_y4.csv")
...
write.csv(plot_df,"../data/init2_beta4.csv")
...
write.csv(plot_df1,"../data/init2_beta04.csv")
...
write.csv(fitS,"../data/init2_S4.csv")
...
write.csv(fitE,"../data/init2_E4.csv")
...
write.csv(fitI,"../data/init2_I4.csv")
...
write.csv(fitR,"../data/init2_R4.csv")


write.csv(1/bi_lst$k$value,"../data/init2_alpha4.csv")
write.csv(1/bi_lst$gamma$value,"../data/init2_gamma4.csv")
