...
library(rbi.helpers)
# Load the data
v <- read.csv("H1N1BM_daily.csv", header=FALSE, stringsAsFactors=FALSE) 
...
write.csv(bi_lst,"../data/Exp1_model3.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp1_y3.csv")
...
write.csv(plot_df,"../data/Exp1_beta3.csv")
...
write.csv(plot_df1,"../data/Exp1_beta03.csv")

Mmodel <- read.csv("simulatestates1_1.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[,4]
E<-Mmodel[,5]
I<-Mmodel[,6]
R<-Mmodel[,7]
...
write.csv(fitS,"../data/Exp1_S3.csv")
...
write.csv(fitE,"../data/Exp1_E3.csv")
...
write.csv(fitI,"../data/Exp1_I3.csv")
...
write.csv(fitR,"../data/Exp1_R3.csv")


write.csv(1/bi_lst$k$value,"../data/Exp1_alpha3.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp1_gamma3.csv")
