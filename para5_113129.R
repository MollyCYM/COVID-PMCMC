...
model dureau {
  ...
  sub parameter {
    k ~ uniform(0,7) // k is the period here, not the rate, i.e. 1/k is the rate
    gamma ~ uniform(0,14) // gamma is the period, not the rate
...
write.csv(bi_lst,"../data/para5_model113129.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y113129.csv")
...
write.csv(plot_df,"../data/para5_beta113129.csv")
...
write.csv(fitS,"../data/para5_S113129.csv")
...
write.csv(fitE,"../data/para5_E113129.csv")
...
write.csv(fitI,"../data/para5_I113129.csv")
...
write.csv(fitR,"../data/para5_R113129.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha113129.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma113129.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma113129.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau113129.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta113129.csv")
write.csv(bi_lst$a$value,"../data/para5_a113129.csv")
write.csv(bi_lst$b$value,"../data/para5_b113129.csv")
