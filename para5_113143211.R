...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg2_y12112d.csv", header=FALSE, stringsAsFactors=FALSE) 
...
init_list <- list(k=5, gamma=9, sigma=sqrt(0.004),theta=0.1,tau=0.1,a=-0.02,b=-0.2)
#LibBi wrapper 
...
write.csv(bi_lst,"../data/para5_model113143211.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y113143211.csv")
...
write.csv(plot_df,"../data/para5_beta113143211.csv")

Mmodel <- read.csv("covidoudg2_model12112.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[-1,7]
E<-Mmodel[-1,9]
I<-Mmodel[-1,11]
R<-Mmodel[-1,13]
...
write.csv(fitS,"../data/para5_S113143211.csv")
...
write.csv(fitE,"../data/para5_E113143211.csv")
...
write.csv(fitI,"../data/para5_I113143211.csv")
...
write.csv(fitR,"../data/para5_R113143211.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha113143211.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma113143211.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma113143211.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau113143211.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta113143211.csv")
write.csv(bi_lst$a$value,"../data/para5_a113143211.csv")
write.csv(bi_lst$b$value,"../data/para5_b113143211.csv")
