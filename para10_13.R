...
write.csv(bi_lst,"../data/para10_model13.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para10_y13.csv")
...
write.csv(plot_df,"../data/para10_beta13.csv")
...
write.csv(fitS,"../data/para10_S13.csv")
...
write.csv(fitE,"../data/para10_E13.csv")
...
write.csv(fitI,"../data/para10_I13.csv")
...
write.csv(fitR,"../data/para10_R13.csv")


write.csv(bi_lst$k$value,"../data/para10_alpha13.csv")
write.csv(bi_lst$gamma$value,"../data/para10_gamma13.csv")
write.csv(bi_lst$sigma$value,"../data/para10_sigma13.csv")
write.csv(bi_lst$tau$value,"../data/para10_tau13.csv")
write.csv(bi_lst$theta$value,"../data/para10_theta13.csv")
write.csv(bi_lst$a$value,"../data/para10_a13.csv")
write.csv(bi_lst$b$value,"../data/para10_b13.csv")
