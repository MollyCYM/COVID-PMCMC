...
model dureau {
  ...
  sub parameter {
    ...
    d ~ truncated_gaussian(0.0087, 0.0001, lower = 0)
...
init_list <- list(k=5, gamma=9, sigma=sqrt(0.004),theta=0.05,d=0.0087,tau=0.1,a=-0.02,b=-0.2,x0=0)
...
write.csv(bi_lst,"../data/para5_model114.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y114.csv")
...
write.csv(plot_df,"../data/para5_beta114.csv")
...
write.csv(fitS,"../data/para5_S114.csv")
...
write.csv(fitE,"../data/para5_E114.csv")
...
write.csv(fitI,"../data/para5_I114.csv")
...
write.csv(fitR,"../data/para5_R114.csv")


write.csv(1/bi_lst$k$value,"../data/para5_alpha114.csv")
write.csv(1/bi_lst$gamma$value,"../data/para5_gamma114.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma114.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau114.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta114.csv")
write.csv(bi_lst$d$value,"../data/para5_d114.csv")
write.csv(bi_lst$a$value,"../data/para5_a114.csv")
write.csv(bi_lst$b$value,"../data/para5_b114.csv")
write.csv(bi_lst$x0$value,"../data/para5_x0114.csv")
