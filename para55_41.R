...
write.csv(fitY,"../data/para55_y41.csv")
...
write.csv(fitS,"../data/para55_S41.csv")
...
write.csv(fitE,"../data/para55_E41.csv")
...
write.csv(fitI,"../data/para55_I41.csv")
...
write.csv(fitR,"../data/para55_R41.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik41.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha41.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma41.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma41.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau41.csv")
