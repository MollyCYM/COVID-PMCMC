...
write.csv(bi_lst,"../data/para1_model111.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y111.csv")
...
write.csv(plot_df,"../data/para1_beta111.csv")
...
write.csv(fitS,"../data/para1_S111.csv")
...
write.csv(fitE,"../data/para1_E111.csv")
...
write.csv(fitI,"../data/para1_I111.csv")
...
write.csv(fitR,"../data/para1_R111.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha111.csv")
write.csv(1/bi_lst$gamma$value,"../data/para1_gamma111.csv")
write.csv(bi_lst$sigma$value,"../data/para1_sigma111.csv")
write.csv(bi_lst$tau$value,"../data/para1_tau111.csv")
