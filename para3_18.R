...
write.csv(bi_lst,"../data/para3_model18.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y18.csv")
...
write.csv(plot_df,"../data/para3_beta18.csv")
...
write.csv(fitS,"../data/para3_S18.csv")
...
write.csv(fitE,"../data/para3_E18.csv")
...
write.csv(fitI,"../data/para3_I18.csv")
...
write.csv(fitR,"../data/para3_R18.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha18.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma18.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma18.csv")
