...
write.csv(fitY,"../data/para3_y21.csv")
...
write.csv(plot_df,"../data/para3_beta21.csv")
...
write.csv(fitS,"../data/para3_S21.csv")
...
write.csv(fitE,"../data/para3_E21.csv")
...
write.csv(fitI,"../data/para3_I21.csv")
...
write.csv(fitR,"../data/para3_R21.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha21.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma21.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma21.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau21.csv")
