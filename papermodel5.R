...
write.csv(plot_df,"37wbeta4.csv")
...
write.csv(plot_df1,"37wbeta14.csv")

write.csv(bi_lst$k$value,"37wpalpha4.csv")
write.csv(1/bi_lst$k$value,"37walpha4.csv")
write.csv(bi_lst$gamma$value,"37wpgamma4.csv")
write.csv(1/bi_lst$gamma$value,"37wgamma4.csv")
