...
gen_ode_model <- function(rep_time = 200, ori_seed = 2023, tims = 365, 
  ...
  times = 1:tims
  N = n
  sigma <- 0.03 #tune sigma to 0: see if convergence or not
  ...
  ## add beta
  betas = setNames(Zs, paste0("beta", 1:rep_time)) 
  ## add e
...
for (i in 1:zs) {
  if (i == 1){
    plot(ode_example$Z[,1], col="darkblue", type = "l", 
         ylim = c(min(ode_example$Z), max(ode_example$Z)),
         xlab = 'Times', ylab = 'Z',main="H1N1_bm model Monte Carlo tirals")
  }
  else{
...
for (i in 1:ys) {
  if (i == 1){
    plot(ode_example$Y[,1], col="darkred", type = "l", 
         ...
         xlab = 'Times', ylab = 'Y',main="H1N1_bm model Monte Carlo tirals")
  }
  else{
...
for (i in 1:ss) {
  if (i == 1){
    plot(ode_example$dS[,1], col="skyblue", type = "l", 
         ...
         xlab = 'Times', ylab = 'S',main="H1N1_bm model Monte Carlo tirals")
  }
  else{
...
for (i in 1:es) {
  if (i == 1){
    plot(ode_example$dE[,1], col="yellow3", type = "l", 
         ...
         xlab = 'Times', ylab = 'E',main="H1N1_bm model Monte Carlo tirals")
  }
  else{
...
for (i in 1:is) {
  if (i == 1){
    plot(ode_example$dI[,1], col="pink3", type = "l", 
         ...
         xlab = 'Times', ylab = 'I',main="H1N1_bm model Monte Carlo tirals")
  }
  else{
...
for (i in 1:rs) {
  if (i == 1){
    plot(ode_example$dR[,1], col="darkgreen", type = "l", 
         ...
         xlab = 'Times', ylab = 'R',main="H1N1_bm model Monte Carlo tirals")
  }
  else{
...
betas = ncol(ode_example$beta)

for (i in 1:betas) {
  if (i == 1){
    plot(ode_example$beta[,1], col="orange", type = "l", 
         ylim = c(min(ode_example$beta), max(ode_example$beta)),
         xlab = 'Times', ylab = expression(beta),main="H1N1_bm model Monte Carlo tirals")
  }
  else{
    lines(ode_example$beta[,i], col="orange")
  }
}
...
for (i in 1:es) {
  if (i == 1){
    plot(ode_example$e[,1], col="brown4", type = "l", 
         ylim = c(min(ode_example$e), max(ode_example$e)),
         xlab = 'Times', ylab = 'x',main="H1N1_bm model Monte Carlo tirals")
  }
  else{
    lines(ode_example$e[,i], col="brown4")
  }
}
