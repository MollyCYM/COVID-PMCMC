...
library(rbi.helpers)
# Load the data
v <- read.csv("H1N1OU_daily2.csv", header=FALSE, stringsAsFactors=FALSE) 
y <- data.frame(value = v) %>%
  mutate(time = seq(1, by = 1, length.out = n())) %>%
  dplyr::select(time, V1)
colnames(y) <- c("time", "value")
L <- read.csv("Forcing1.csv", header=FALSE, stringsAsFactors=FALSE)
...
write.csv(bi_lst,"../data/Exp3_model4.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp3_y4.csv")
...
write.csv(plot_df,"../data/Exp3_beta4.csv")
...
write.csv(plot_df1,"../data/Exp3_beta04.csv")
...
write.csv(fitmu,"../data/Exp3_mu4.csv")

Mmodel <- read.csv("h1n1ousimulates2.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[,4]
E<-Mmodel[,5]
I<-Mmodel[,6]
R<-Mmodel[,7]
...
write.csv(fitS,"../data/Exp3_S4.csv")
...
write.csv(fitE,"../data/Exp3_E4.csv")
...
write.csv(fitI,"../data/Exp3_I4.csv")
...
write.csv(fitR,"../data/Exp3_R4.csv")

write.csv(1/bi_lst$k$value,"../data/Exp3_alpha4.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp3_gamma4.csv")
write.csv(bi_lst$sigma$value,"../data/Exp3_sigma4.csv")
write.csv(bi_lst$theta$value,"../data/Exp3_theta4.csv")
