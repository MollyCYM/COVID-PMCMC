...
write.csv(bi_lst,"../data/para1_model2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y2.csv")
...
write.csv(plot_df,"../data/para1_beta2.csv")
...
write.csv(fitS,"../data/para1_S2.csv")
...
write.csv(fitE,"../data/para1_E2.csv")
...
write.csv(fitI,"../data/para1_I2.csv")
...
write.csv(fitR,"../data/para1_R2.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha2.csv")
