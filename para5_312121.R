...
init_list <- list(k=7, gamma=11, sigma=0.08,theta=0.08,a=-0.03,b=-0.3)
#LibBi wrapper 
...
write.csv(bi_lst$k$value,"../data/para5_alpha312121.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma312121.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma312121.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta312121.csv")
write.csv(bi_lst$a$value,"../data/para5_a312121.csv")
write.csv(bi_lst$b$value,"../data/para5_b312121.csv")
