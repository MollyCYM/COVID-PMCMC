...
write.csv(bi_lst,"../data/para5_model111.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y111.csv")
...
write.csv(plot_df,"../data/para5_beta111.csv")
...
write.csv(fitS,"../data/para5_S111.csv")
...
write.csv(fitE,"../data/para5_E111.csv")
...
write.csv(fitI,"../data/para5_I111.csv")
...
write.csv(fitR,"../data/para5_R111.csv")


write.csv(1/bi_lst$k$value,"../data/para5_alpha111.csv")
write.csv(1/bi_lst$gamma$value,"../data/para5_gamma111.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma111.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau111.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta111.csv")
write.csv(bi_lst$a$value,"../data/para5_a111.csv")
write.csv(bi_lst$b$value,"../data/para5_b111.csv")
