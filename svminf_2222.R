...
write.csv(fitY,"../data/svminf_y2222.csv")

fitalpha <- bi_lst$alpha %>%
  group_by(time) %>%
  ungroup()
write.csv(fitalpha,"../data/svminf_alpha2222.csv")
write.csv(bi_lst$loglikelihood$value,"../data/svminf_loglik2222.csv")
write.csv(bi_lst$beta$value,"../data/svminf_beta2222.csv")
write.csv(bi_lst$phi$value,"../data/svminf_phi2222.csv")
write.csv(bi_lst$sigma_eta$value,"../data/svminf_sigma2222.csv")