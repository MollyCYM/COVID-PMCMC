...
write.csv(bi_lst, "../data/h1n11.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/h1n1_y1.csv")
...
write.csv(plot_df,"../data/h1n1_beta1.csv")
...
write.csv(fitS,"../data/h1n1_S1.csv")
...
write.csv(fitE,"../data/h1n1_E1.csv")
...
write.csv(fitI,"../data/h1n1_I1.csv")
...
write.csv(fitR,"../data/h1n1_R1.csv")



write.csv(1/bi_lst$k$value,"../data/h1n1_alpha1.csv")
write.csv(1/bi_lst$gamma$value,"../data/h1n1_gamma1.csv")
