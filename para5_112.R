...
model dureau {
  ...
  sub parameter {
    k ~ truncated_gaussian(5, 0.5, lower = 0) // k is the period here, not the rate, i.e. 1/k is the rate
    gamma ~ truncated_gaussian(9, 0.5, lower = 0) // gamma is the period, not the rate
...
write.csv(bi_lst,"../data/para5_model112.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y112.csv")
...
write.csv(plot_df,"../data/para5_beta112.csv")

Mmodel <- read.csv("covidoudg_model1.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[,4]
E<-Mmodel[,5]
I<-Mmodel[,6]
R<-Mmodel[,7]
...
write.csv(fitS,"../data/para5_S112.csv")
...
write.csv(fitE,"../data/para5_E112.csv")
...
write.csv(fitI,"../data/para5_I112.csv")
...
write.csv(fitR,"../data/para5_R112.csv")


write.csv(1/bi_lst$k$value,"../data/para5_alpha112.csv")
write.csv(1/bi_lst$gamma$value,"../data/para5_gamma112.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma112.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau112.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta112.csv")
write.csv(bi_lst$a$value,"../data/para5_a112.csv")
write.csv(bi_lst$b$value,"../data/para5_b112.csv")
write.csv(bi_lst$x0$value,"../data/para5_x0112.csv")
