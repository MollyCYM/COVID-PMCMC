...
write.csv(bi_lst,"../data/para5_model1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y1.csv")
...
write.csv(plot_df,"../data/para5_beta1.csv")
...
write.csv(fitS,"../data/para5_S1.csv")
...
write.csv(fitE,"../data/para5_E1.csv")
...
write.csv(fitI,"../data/para5_I1.csv")
...
write.csv(fitR,"../data/para5_R1.csv")


write.csv(1/bi_lst$k$value,"../data/para5_alpha1.csv")
write.csv(1/bi_lst$gamma$value,"../data/para5_gamma1.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma1.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau1.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta1.csv")
write.csv(bi_lst$a$value,"../data/para5_a1.csv")
write.csv(bi_lst$b$value,"../data/para5_b1.csv")
