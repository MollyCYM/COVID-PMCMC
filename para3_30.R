...
library(rbi.helpers)
# Load the data
v <- read.csv("H1N1BM_wk4.csv", header=FALSE, stringsAsFactors=FALSE) %>%
  rowSums()
...
write.csv(bi_lst,"../data/para3_model25.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y25.csv")
...
write.csv(plot_df,"../data/para3_beta25.csv")
...
write.csv(fitS,"../data/para3_S25.csv")
...
write.csv(fitE,"../data/para3_E25.csv")
...
write.csv(fitI,"../data/para3_I25.csv")
...
write.csv(fitR,"../data/para3_R25.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha25.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma25.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma25.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau25.csv")
