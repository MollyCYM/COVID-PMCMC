...
write.csv(fitY,"../data/para55_y51.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x51.csv")
...
write.csv(fitS,"../data/para55_S51.csv")
...
write.csv(fitE,"../data/para55_E51.csv")
...
write.csv(fitI,"../data/para55_I51.csv")
...
write.csv(fitR,"../data/para55_R51.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik51.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha51.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma51.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma51.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau51.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta51.csv")
write.csv(bi_lst$a$value,"../data/para55_a51.csv")
write.csv(bi_lst$b$value,"../data/para55_b51.csv")
