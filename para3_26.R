...
bi <- sample(bi_model, end_time = end_time, input = input_lst, init=init_list, obs = obs_lst, nsamples = 2000, nparticles = minParticles, nthreads = ncores, proposal = 'model',seed=123111) %>% 
...
write.csv(bi_lst,"../data/para3_model26.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y26.csv")
...
write.csv(plot_df,"../data/para3_beta26.csv")
...
write.csv(fitS,"../data/para3_S26.csv")
...
write.csv(fitE,"../data/para3_E26.csv")
...
write.csv(fitI,"../data/para3_I26.csv")
...
write.csv(fitR,"../data/para3_R26.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha26.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma26.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma26.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau26.csv")
