...
#RBi.helpers adapt_particle and change pf type to lookahead
particles_adapted <- bi_model %>%
  sample(nsamples = 2000, nparticles = minParticles, filter= 'lookahead',
         nthreads = ncores, proposal = 'prior',seed=00000888) %>%
...
proposal_adapted <- particles_adapted %>%
  sample(target = "posterior", nsamples = 2000, 
         nthreads = ncores, proposal = 'model',seed=00000888) %>%
...
write.csv(bi_lst,"../data/para5_model3121231.csv")
fitY <- bi_lst$y  %>% 
  group_by(time)  %>% 
  mutate(
...
write.csv(fitY,"../data/para5_y3121231.csv")
...
write.csv(plot_df,"../data/para5_beta3121231.csv")
...
write.csv(fitS,"../data/para5_S3121231.csv")
...
write.csv(fitE,"../data/para5_E3121231.csv")
...
write.csv(fitI,"../data/para5_I3121231.csv")
...
write.csv(fitR,"../data/para5_R3121231.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha3121231.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma3121231.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma3121231.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta3121231.csv")
write.csv(bi_lst$a$value,"../data/para5_a3121231.csv")
write.csv(bi_lst$b$value,"../data/para5_b3121231.csv")
