...
write.csv(bi_lst,"../data/para4_model112.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para4_y112.csv")
...
write.csv(plot_df,"../data/para4_beta112.csv")
...
write.csv(fitS,"../data/para4_S112.csv")
...
write.csv(fitE,"../data/para4_E112.csv")
...
write.csv(fitI,"../data/para4_I112.csv")
...
write.csv(fitR,"../data/para4_R112.csv")


write.csv(1/bi_lst$k$value,"../data/para4_alpha112.csv")
write.csv(1/bi_lst$gamma$value,"../data/para4_gamma112.csv")
write.csv(bi_lst$sigma$value,"../data/para4_sigma112.csv")
write.csv(bi_lst$tau$value,"../data/para4_tau112.csv")
