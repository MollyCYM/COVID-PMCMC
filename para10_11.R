...
write.csv(bi_lst,"../data/para10_model11.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para10_y11.csv")
...
write.csv(plot_df,"../data/para10_beta11.csv")
...
write.csv(fitS,"../data/para10_S11.csv")
...
write.csv(fitE,"../data/para10_E11.csv")
...
write.csv(fitI,"../data/para10_I11.csv")
...
write.csv(fitR,"../data/para10_R11.csv")


write.csv(bi_lst$k$value,"../data/para10_alpha11.csv")
write.csv(bi_lst$gamma$value,"../data/para10_gamma11.csv")
write.csv(bi_lst$sigma$value,"../data/para10_sigma11.csv")
write.csv(bi_lst$tau$value,"../data/para10_tau11.csv")
write.csv(bi_lst$theta$value,"../data/para10_theta11.csv")
write.csv(bi_lst$a$value,"../data/para10_a11.csv")
write.csv(bi_lst$b$value,"../data/para10_b11.csv")
