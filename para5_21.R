...
write.csv(bi_lst,"../data/para5_model21.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y21.csv")
...
write.csv(plot_df,"../data/para5_beta21.csv")
...
write.csv(fitS,"../data/para5_S21.csv")
...
write.csv(fitE,"../data/para5_E21.csv")
...
write.csv(fitI,"../data/para5_I21.csv")
...
write.csv(fitR,"../data/para5_R21.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha21.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma21.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma21.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau21.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta21.csv")
write.csv(bi_lst$a$value,"../data/para5_a21.csv")
write.csv(bi_lst$b$value,"../data/para5_b21.csv")
