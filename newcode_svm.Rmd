...
write.csv(fitY,"svm_y2.csv")
fitY <- read.csv("svm_y2.csv", header=TRUE, stringsAsFactors=FALSE)
g1 <- ggplot(data = fitY) +
...
write.csv(fitalpha,"svm_alphainf1.csv")
fitalpha <- read.csv("svm_alphainf1.csv", header=TRUE, stringsAsFactors=FALSE)
