...
write.csv(bi_lst,"../data/para3_model6.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y6.csv")
...
write.csv(plot_df,"../data/para3_beta6.csv")
...
write.csv(fitS,"../data/para3_S6.csv")
...
write.csv(fitE,"../data/para3_E6.csv")
...
write.csv(fitI,"../data/para3_I6.csv")
...
write.csv(fitR,"../data/para3_R6.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha6.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma6.csv")
