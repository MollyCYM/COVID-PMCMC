...
write.csv(bi_lst,"../data/para5_model1131436211.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y1131436211.csv")
...
write.csv(plot_df,"../data/para5_beta1131436211.csv")
...
write.csv(fitS,"../data/para5_S1131436211.csv")
...
write.csv(fitE,"../data/para5_E1131436211.csv")
...
write.csv(fitI,"../data/para5_I1131436211.csv")
...
write.csv(fitR,"../data/para5_R1131436211.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha1131436211.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma1131436211.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma1131436211.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau1131436211.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta1131436211.csv")
write.csv(bi_lst$a$value,"../data/para5_a1131436211.csv")
write.csv(bi_lst$b$value,"../data/para5_b1131436211.csv")
