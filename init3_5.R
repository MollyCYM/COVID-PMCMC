...
init_list <- list(sigma=sqrt(0.008), gamma=8, k=8, theta=0.08, tau=0.9)
...
write.csv(bi_lst,"../data/init3_model3.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init3_y3.csv")
...
write.csv(plot_df,"../data/init3_beta3.csv")
...
write.csv(plot_df1,"../data/init3_beta03.csv")
...
write.csv(fitmu,"../data/init3_mu3.csv")
...
write.csv(fitS,"../data/init3_S3.csv")
...
write.csv(fitE,"../data/init3_E3.csv")
...
write.csv(fitI,"../data/init3_I3.csv")
...
write.csv(fitR,"../data/init3_R3.csv")

write.csv(1/bi_lst$k$value,"../data/init3_alpha3.csv")
write.csv(1/bi_lst$gamma$value,"../data/init3_gamma3.csv")
write.csv(bi_lst$sigma$value,"../data/init3_sigma3.csv")
write.csv(bi_lst$theta$value,"../data/init3_theta3.csv")
