...
write.csv(bi_lst,"../data/para5_model312124.csv")
fitY <- bi_lst$y  %>% 
  group_by(time)  %>% 
  mutate(
...
write.csv(fitY,"../data/para5_y312124.csv")
...
write.csv(plot_df,"../data/para5_beta312124.csv")
...
write.csv(fitS,"../data/para5_S312124.csv")
...
write.csv(fitE,"../data/para5_E312124.csv")
...
write.csv(fitI,"../data/para5_I312124.csv")
...
write.csv(fitR,"../data/para5_R312124.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha312124.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma312124.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma312124.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta312124.csv")
write.csv(bi_lst$a$value,"../data/para5_a312124.csv")
write.csv(bi_lst$b$value,"../data/para5_b312124.csv")
