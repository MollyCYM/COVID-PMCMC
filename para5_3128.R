...
bi <- sample(bi_model,target = "posterior", end_time = end_time, input = input_lst, init=init_list, obs = obs_lst, nsamples = 2000, nparticles = minParticles, nthreads = ncores, proposal = 'model',seed=00666611) %>% 
...
write.csv(bi_lst,"../data/para5_model3128.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y3128.csv")
...
write.csv(plot_df,"../data/para5_beta3128.csv")
...
write.csv(fitS,"../data/para5_S3128.csv")
...
write.csv(fitE,"../data/para5_E3128.csv")
...
write.csv(fitI,"../data/para5_I3128.csv")
...
write.csv(fitR,"../data/para5_R3128.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha3128.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma3128.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma3128.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta3128.csv")
write.csv(bi_lst$a$value,"../data/para5_a3128.csv")
write.csv(bi_lst$b$value,"../data/para5_b3128.csv")
