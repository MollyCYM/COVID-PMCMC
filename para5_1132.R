...
bi <- sample(bi_model,target = "posterior", end_time = end_time, input = input_lst, init=init_list, obs = obs_lst, nsamples = 2000, nparticles = minParticles, nthreads = ncores, proposal = 'model',seed=00666612) %>% 
...
write.csv(bi_lst,"../data/para5_model1132.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y1132.csv")
...
write.csv(plot_df,"../data/para5_beta1132.csv")
...
write.csv(fitS,"../data/para5_S1132.csv")
...
write.csv(fitE,"../data/para5_E1132.csv")
...
write.csv(fitI,"../data/para5_I1132.csv")
...
write.csv(fitR,"../data/para5_R1132.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha1132.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma1132.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma1132.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau1132.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta1132.csv")
write.csv(bi_lst$a$value,"../data/para5_a1132.csv")
write.csv(bi_lst$b$value,"../data/para5_b1132.csv")
