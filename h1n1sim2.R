...
write.csv(bi_lst, "../data/h1n12.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/h1n1_y2.csv")
...
write.csv(plot_df,"../data/h1n1_beta2.csv")
...
write.csv(fitS,"../data/h1n1_S2.csv")
...
write.csv(fitE,"../data/h1n1_E2.csv")
...
write.csv(fitI,"../data/h1n1_I2.csv")
...
write.csv(fitR,"../data/h1n1_R2.csv")



write.csv(1/bi_lst$k$value,"../data/h1n1_alpha2.csv")
write.csv(1/bi_lst$gamma$value,"../data/h1n1_gamma2.csv")
