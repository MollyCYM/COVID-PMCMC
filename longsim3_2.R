...
write.csv(bi_lst, "../data/MSEIR3_2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitM,"../data/MM3_2.csv")

write.csv(bi_lst$sigma$value,"../data/Msigma3_2.csv")
write.csv(bi_lst$gamma$value,"../data/Mgamma3_2.csv")
write.csv(bi_lst$beta$value,"../data/Mbeta3_2.csv")
write.csv(bi_lst$mu$value,"../data/Mmu3_2.csv")
