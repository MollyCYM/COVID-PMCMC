...
write.csv(fitY,"../data/para5_y312122.csv")
...
write.csv(plot_df,"../data/para5_beta312122.csv")
...
write.csv(fitR,"../data/para5_R312122.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha312122.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma312122.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma312122.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta312122.csv")
write.csv(bi_lst$a$value,"../data/para5_a312122.csv")
write.csv(bi_lst$b$value,"../data/para5_b312122.csv")
