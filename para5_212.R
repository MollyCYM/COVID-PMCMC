...
write.csv(bi_lst,"../data/para5_model212.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y212.csv")
...
write.csv(plot_df,"../data/para5_beta212.csv")
...
write.csv(fitS,"../data/para5_S212.csv")
...
write.csv(fitE,"../data/para5_E212.csv")
...
write.csv(fitI,"../data/para5_I212.csv")
...
write.csv(fitR,"../data/para5_R212.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha212.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma212.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma212.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta212.csv")
write.csv(bi_lst$a$value,"../data/para5_a212.csv")
write.csv(bi_lst$b$value,"../data/para5_b212.csv")
