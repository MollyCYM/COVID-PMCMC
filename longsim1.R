...
write.csv(fitM,"../data/MM1.csv")

write.csv(bi_lst$sigma$value,"../data/Msigma1.csv")
write.csv(bi_lst$gamma$value,"../data/Mgamma1.csv")
write.csv(bi_lst$beta$value,"../data/Mbeta1.csv")
write.csv(bi_lst$mu$value,"../data/Mmu1.csv")
