...
init_list <- list(k=3, gamma=7, sigma=0.04, theta=0.03, a=-0.01, b=-0.1)
#LibBi wrapper 
...
write.csv(fitY,"../data/para55_y312153111.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x312153111.csv")

Mmodel <- read.csv("seirou_model1.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[-1,7]
E<-Mmodel[-1,9]
I<-Mmodel[-1,11]
R<-Mmodel[-1,13]
...
write.csv(fitS,"../data/para55_S312153111.csv")
...
write.csv(fitE,"../data/para55_E312153111.csv")
...
write.csv(fitI,"../data/para55_I312153111.csv")
...
write.csv(fitR,"../data/para55_R312153111.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik312153111.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha312153111.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma312153111.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma312153111.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta312153111.csv")
write.csv(bi_lst$a$value,"../data/para55_a312153111.csv")
write.csv(bi_lst$b$value,"../data/para55_b312153111.csv")
