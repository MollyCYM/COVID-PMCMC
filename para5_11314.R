...
write.csv(bi_lst,"../data/para5_model11314.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y11314.csv")
...
write.csv(plot_df,"../data/para5_beta11314.csv")
...
write.csv(fitS,"../data/para5_S11314.csv")
...
write.csv(fitE,"../data/para5_E11314.csv")
...
write.csv(fitI,"../data/para5_I11314.csv")
...
write.csv(fitR,"../data/para5_R11314.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha11314.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma11314.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma11314.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau11314.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta11314.csv")
write.csv(bi_lst$a$value,"../data/para5_a11314.csv")
write.csv(bi_lst$b$value,"../data/para5_b11314.csv")
