...
model dureau {
  ...
  sub parameter {
    ...
    gamma ~ truncated_gaussian(3, 1, lower = 0) // gamma is the period, not the rate
    sigma ~ truncated_gaussian(0.2, 0.1, lower = 0)
    theta ~ truncated_gaussian(0.1, 0.01, lower = 0)
    tau ~ truncated_gaussian(0.2, 0.01, lower = 0)
    a ~ truncated_gaussian(-0.05, 0.01, upper = 0)
    b ~ truncated_gaussian(-0.5, 0.1, upper = 0)
  }
...
write.csv(fitY,"../data/para55_y81.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x81.csv")
...
write.csv(fitS,"../data/para55_S81.csv")
...
write.csv(fitE,"../data/para55_E81.csv")
...
write.csv(fitI,"../data/para55_I81.csv")
...
write.csv(fitR,"../data/para55_R81.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik81.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha81.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma81.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma81.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau81.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta81.csv")
write.csv(bi_lst$a$value,"../data/para55_a81.csv")
write.csv(bi_lst$b$value,"../data/para55_b81.csv")
