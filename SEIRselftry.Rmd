...
model dureau {
  ...
  sub parameter {
    k ~ log_gaussian(1.83,0.53) // k is the average onset symptoms period here, not the rate, i.e. 1/k is the rate
  ...
  sub transition(delta = 1) {
    ...
    ode(alg = 'RK4(3)', h = 1.0, atoler = 1.0e-3, rtoler = 1.0e-8) {
      ...
      dE/dt = -exp(x)*(E+0.1*I)*S/N - E/k
      dI/dt = E/k-I*(1/gamma+0.004)
      dR/dt = (I+E)/gamma
    }
  }
