...
write.csv(bi_lst,"../data/Exp1_model21.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp1_y21.csv")
...
write.csv(plot_df,"../data/Exp1_beta21.csv")
...
write.csv(plot_df1,"../data/Exp1_beta021.csv")
...
write.csv(fitS,"../data/Exp1_S21.csv")
...
write.csv(fitE,"../data/Exp1_E21.csv")
...
write.csv(fitI,"../data/Exp1_I21.csv")
...
write.csv(fitR,"../data/Exp1_R21.csv")


write.csv(1/bi_lst$k$value,"../data/Exp1_alpha21.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp1_gamma21.csv")
