...
write.csv(bi_lst,"../data/para1_model81.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y81.csv")
...
write.csv(plot_df,"../data/para1_beta81.csv")
...
write.csv(fitS,"../data/para1_S81.csv")
...
write.csv(fitE,"../data/para1_E81.csv")
...
write.csv(fitI,"../data/para1_I81.csv")
...
write.csv(fitR,"../data/para1_R81.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha81.csv")
write.csv(1/bi_lst$gamma$value,"../data/para1_gamma81.csv")
write.csv(bi_lst$sigma$value,"../data/para1_sigma81.csv")
write.csv(bi_lst$tau$value,"../data/para1_tau81.csv")
