...
gen_ode_model <- function(rep_time = 200, ori_seed = 2023, tims = 365, 
  ...
  for (rep_i in 1:rep_time) {
    ...
    x = ornstein_uhlenbeck(tims, 0.05, 0.01, 0, tims,mu,e)
...
for (i in 1:zs) {
  if (i == 1){
    plot(ode_example$Z[,1], col="darkblue", type = "l", 
         ...
         xlab = 'Times', ylab = 'Z',main="Covid_ou model Monte Carlo tirals")
    }
  else{
...
for (i in 1:ys) {
  if (i == 1){
    plot(ode_example$Y[,1], col="darkred", type = "l", 
         ...
         xlab = 'Times', ylab = 'Y',main="Covid_ou model Monte Carlo tirals")
  }
  else{
...
for (i in 1:ss) {
  if (i == 1){
    plot(ode_example$dS[,1], col="skyblue", type = "l", 
         ...
         xlab = 'Times', ylab = 'S',main="Covid_ou model Monte Carlo tirals")
  }
  else{
...
for (i in 1:is) {
  if (i == 1){
    plot(ode_example$dI[,1], col="pink3", type = "l", 
         ...
         xlab = 'Times', ylab = 'I',main="Covid_ou model Monte Carlo tirals")
  }
  else{
...
for (i in 1:rs) {
  if (i == 1){
    plot(ode_example$dR[,1], col="darkgreen", type = "l", 
         ...
         xlab = 'Times', ylab = 'R',main="Covid_ou model Monte Carlo tirals")
  }
  else{
...
for (i in 1:xs) {
  if (i == 1){
    plot(exp(ode_example$x[,1]), col="orange2", type = "l", 
         ...
         xlab = 'Times', ylab = 'beta',main="Covid_ou model Monte Carlo tirals")
  }
  else{
...
for (i in 1:xs) {
  if (i == 1){
    plot(exp(ode_example$x[,1]), col="orange2", type = "l", 
         ...
         xlab = 'Times', ylab = 'x',main="Covid_ou model Monte Carlo tirals")
  }
  else{
