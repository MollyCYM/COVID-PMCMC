...
write.csv(bi_lst,"../data/para6_model3.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para6_y3.csv")
...
write.csv(plot_df,"../data/para6_beta3.csv")
...
write.csv(fitS,"../data/para6_S3.csv")
...
write.csv(fitE,"../data/para6_E3.csv")
...
write.csv(fitI,"../data/para6_I3.csv")
...
write.csv(fitR,"../data/para6_R3.csv")
