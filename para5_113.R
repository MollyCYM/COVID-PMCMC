...
write.csv(bi_lst,"../data/para5_model113.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y113.csv")
...
write.csv(plot_df,"../data/para5_beta113.csv")
...
write.csv(fitS,"../data/para5_S113.csv")
...
write.csv(fitE,"../data/para5_E113.csv")
...
write.csv(fitI,"../data/para5_I113.csv")
...
write.csv(fitR,"../data/para5_R113.csv")


write.csv(1/bi_lst$k$value,"../data/para5_alpha113.csv")
write.csv(1/bi_lst$gamma$value,"../data/para5_gamma113.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma113.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau113.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta113.csv")
write.csv(bi_lst$a$value,"../data/para5_a113.csv")
write.csv(bi_lst$b$value,"../data/para5_b113.csv")
write.csv(bi_lst$x0$value,"../data/para5_x0113.csv")
