...
init_list <- list(k=3,gamma=3,sigma=sqrt(0.003),theta=0.04,a=-0.02,b=-0.2)
...
write.csv(bi_lst,"../data/para22_model3.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para22_y3.csv")
...
write.csv(plot_df,"../data/para22_beta3.csv")
...
write.csv(fitS,"../data/para22_S3.csv")
...
write.csv(fitE,"../data/para22_E3.csv")
...
write.csv(fitI,"../data/para22_I3.csv")
...
write.csv(fitR,"../data/para22_R3.csv")

write.csv(1/bi_lst$k$value,"../data/para22_alpha3.csv")
write.csv(1/bi_lst$gamma$value,"../data/para22_gamma3.csv")
write.csv(bi_lst$sigma$value,"../data/para22_sigma3.csv")
write.csv(bi_lst$theta$value,"../data/para22_theta3.csv")
write.csv(bi_lst$tau$value,"../data/para22_tau3.csv")
write.csv(bi_lst$a$value,"../data/para22_a3.csv")
write.csv(bi_lst$b$value,"../data/para22_b3.csv")
