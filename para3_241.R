...
e1 <- read.csv("simulateh1n1x1.csv", header=TRUE, stringsAsFactors=FALSE)
...
bi <- sample(bi_model, end_time = end_time, input = input_lst, init=init_list, obs = obs_lst, 
             nsamples = 2000, nparticles = minParticles, nthreads = ncores, proposal = 'model',seed=123) %>% 
...
write.csv(bi_lst,"../data/para3_model241.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y241.csv")
...
write.csv(fitS,"../data/para3_S241.csv")
...
write.csv(fitE,"../data/para3_E241.csv")
...
write.csv(fitI,"../data/para3_I241.csv")
...
write.csv(fitR,"../data/para3_R241.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha241.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma241.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma241.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau241.csv")
