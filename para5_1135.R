...
model dureau {
  ...
  sub parameter {
    k ~ truncated_gaussian(1/5, 0.1, lower = 0) // k is the period here, not the rate, i.e. 1/k is the rate
    gamma ~ truncated_gaussian(1/9, 0.1, lower = 0) // gamma is the period, not the rate
