...
beta1 <- read.csv("simulateh1n1beta.csv", header=FALSE, stringsAsFactors=FALSE)
...
write.csv(fitS,"../data/para3_S24.csv")
...
write.csv(fitE,"../data/para3_E24.csv")
...
write.csv(fitI,"../data/para3_I24.csv")
...
write.csv(fitR,"../data/para3_R24.csv")
