...
bi <- sample(bi_model, end_time = end_time, input = input_lst, init=init_list, obs = obs_lst, nsamples = 2000, nparticles = minParticles, nthreads = ncores, proposal = 'prior',seed=123) %>% 
...
write.csv(bi_lst,"../data/para3_model29.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y29.csv")
...
write.csv(plot_df,"../data/para3_beta29.csv")
...
write.csv(fitS,"../data/para3_S29.csv")
...
write.csv(fitE,"../data/para3_E29.csv")
...
write.csv(fitI,"../data/para3_I29.csv")
...
write.csv(fitR,"../data/para3_R29.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha29.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma29.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma29.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau29.csv")
