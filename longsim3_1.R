...
write.csv(bi_lst, "../data/MSEIR3_1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitM,"../data/MM3_1.csv")

write.csv(bi_lst$sigma$value,"../data/Msigma3_1.csv")
write.csv(bi_lst$gamma$value,"../data/Mgamma3_1.csv")
write.csv(bi_lst$beta$value,"../data/Mbeta3_1.csv")
write.csv(bi_lst$mu$value,"../data/Mmu3_1.csv")
