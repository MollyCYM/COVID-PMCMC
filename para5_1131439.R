...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg2_y1212d.csv", header=FALSE, stringsAsFactors=FALSE) 
...
model dureau {
  ...
  sub parameter {
    ...
    theta ~ truncated_gaussian(0.4, 0.5, lower = 0)
...
init_list <- list(k=5, gamma=9, sigma=sqrt(0.004),theta=0.4,tau=0.1,a=-0.02,b=-0.2)
#LibBi wrapper 
...
write.csv(bi_lst,"../data/para5_model1131439.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y1131439.csv")
...
write.csv(plot_df,"../data/para5_beta1131439.csv")

Mmodel <- read.csv("covidoudg2_model1212.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[-1,7]
E<-Mmodel[-1,9]
I<-Mmodel[-1,11]
R<-Mmodel[-1,13]
...
write.csv(fitS,"../data/para5_S1131439.csv")
...
write.csv(fitE,"../data/para5_E1131439.csv")
...
write.csv(fitI,"../data/para5_I1131439.csv")
...
write.csv(fitR,"../data/para5_R1131439.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha1131439.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma1131439.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma1131439.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau1131439.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta1131439.csv")
write.csv(bi_lst$a$value,"../data/para5_a1131439.csv")
write.csv(bi_lst$b$value,"../data/para5_b1131439.csv")
