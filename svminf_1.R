...
bi <- proposal_adapted %>%
  sample(nsamples = 15000, thin = 1, init=init_list)
...
write.csv(fitY,"../data/svminf_y1.csv")
...
write.csv(fitalpha,"../data/svminf_alpha1.csv")

write.csv(bi_lst$beta$value,"../data/svminf_beta1.csv")
write.csv(bi_lst$phi$value,"../data/svminf_phi1.csv")
write.csv(bi_lst$sigma_eta$value,"../data/svminf_sigma1.csv")