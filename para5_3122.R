...
write.csv(bi_lst,"../data/para5_model3122.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y3122.csv")
...
write.csv(plot_df,"../data/para5_beta3122.csv")
...
write.csv(fitS,"../data/para5_S3122.csv")
...
write.csv(fitE,"../data/para5_E3122.csv")
...
write.csv(fitI,"../data/para5_I3122.csv")
...
write.csv(fitR,"../data/para5_R3122.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha3122.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma3122.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma3122.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau3122.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta3122.csv")
write.csv(bi_lst$a$value,"../data/para5_a3122.csv")
write.csv(bi_lst$b$value,"../data/para5_b3122.csv")
