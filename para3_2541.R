...
init_list <- list(sigma=0.7, gamma=1.08, k=1.59, tau=0.5)
...
write.csv(bi_lst,"../data/para3_model2541.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y2541.csv")
...
write.csv(plot_df,"../data/para3_beta2541.csv")
...
write.csv(fitS,"../data/para3_S2541.csv")
...
write.csv(fitE,"../data/para3_E2541.csv")
...
write.csv(fitI,"../data/para3_I2541.csv")
...
write.csv(fitR,"../data/para3_R2541.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha2541.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma2541.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma2541.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau2541.csv")
