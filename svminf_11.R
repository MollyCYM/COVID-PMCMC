...
write.csv(fitY,"../data/svminf_y11.csv")
...
write.csv(fitalpha,"../data/svminf_alpha11.csv")

write.csv(bi_lst$beta$value,"../data/svminf_beta11.csv")
write.csv(bi_lst$phi$value,"../data/svminf_phi11.csv")
write.csv(bi_lst$sigma_eta$value,"../data/svminf_sigma11.csv")