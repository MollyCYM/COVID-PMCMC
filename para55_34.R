...
write.csv(fitY,"../data/para55_y34.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x34.csv")
...
write.csv(fitS,"../data/para55_S34.csv")
...
write.csv(fitE,"../data/para55_E34.csv")
...
write.csv(fitI,"../data/para55_I34.csv")
...
write.csv(fitR,"../data/para55_R34.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik34.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha34.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma34.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma34.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau34.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta34.csv")
write.csv(bi_lst$a$value,"../data/para55_a34.csv")
write.csv(bi_lst$b$value,"../data/para55_b34.csv")
