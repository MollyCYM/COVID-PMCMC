...
write.csv(fitY,"../data/para55_y82.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x82.csv")
...
write.csv(fitS,"../data/para55_S82.csv")
...
write.csv(fitE,"../data/para55_E82.csv")
...
write.csv(fitI,"../data/para55_I82.csv")
...
write.csv(fitR,"../data/para55_R82.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik82.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha82.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma82.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma82.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau82.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta82.csv")
write.csv(bi_lst$a$value,"../data/para55_a82.csv")
write.csv(bi_lst$b$value,"../data/para55_b82.csv")
