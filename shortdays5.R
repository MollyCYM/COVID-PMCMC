...
write.csv(bi_lst, "../data/short5.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/short_y5.csv")
...
write.csv(fitS,"../data/short_S5.csv")
...
write.csv(fitE,"../data/short_E5.csv")
...
write.csv(fitI,"../data/short_I5.csv")
...
write.csv(fitR,"../data/short_R5.csv")
...
write.csv(fitM,"../data/short_M5.csv")

write.csv(bi_lst$sigma$value,"../data/short_sigma5.csv")
write.csv(bi_lst$gamma$value,"../data/short_gamma5.csv")
write.csv(bi_lst$beta$value,"../data/short_beta5.csv")
write.csv(bi_lst$mu$value,"../data/short_mu5.csv")
