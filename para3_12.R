...
write.csv(bi_lst,"../data/para3_model12.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y12.csv")
...
write.csv(plot_df,"../data/para3_beta12.csv")
...
write.csv(fitS,"../data/para3_S12.csv")
...
write.csv(fitE,"../data/para3_E12.csv")
...
write.csv(fitI,"../data/para3_I12.csv")
...
write.csv(fitR,"../data/para3_R12.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha12.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma12.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma12.csv")
