...
write.csv(bi_lst,"../data/para3_model14.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y14.csv")
...
write.csv(plot_df,"../data/para3_beta14.csv")
...
write.csv(fitS,"../data/para3_S14.csv")
...
write.csv(fitE,"../data/para3_E14.csv")
...
write.csv(fitI,"../data/para3_I14.csv")
...
write.csv(fitR,"../data/para3_R14.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha14.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma14.csv")
