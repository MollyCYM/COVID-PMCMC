...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg2_y3fw.csv", header=FALSE, stringsAsFactors=FALSE) %>%
  rowSums()
...
write.csv(bi_lst,"../data/para5_model113144.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y113144.csv")
...
write.csv(plot_df,"../data/para5_beta113144.csv")

Mmodel <- read.csv("covidoudg2_model125.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[-1,7]
E<-Mmodel[-1,9]
I<-Mmodel[-1,11]
R<-Mmodel[-1,13]
...
write.csv(fitS,"../data/para5_S113144.csv")
...
write.csv(fitE,"../data/para5_E113144.csv")
...
write.csv(fitI,"../data/para5_I113144.csv")
...
write.csv(fitR,"../data/para5_R113144.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha113144.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma113144.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma113144.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau113144.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta113144.csv")
write.csv(bi_lst$a$value,"../data/para5_a113144.csv")
write.csv(bi_lst$b$value,"../data/para5_b113144.csv")
