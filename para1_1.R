...
write.csv(bi_lst,"../data/para1_model1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y1.csv")
...
write.csv(plot_df,"../data/para1_beta1.csv")
...
write.csv(fitS,"../data/para1_S1.csv")
...
write.csv(fitE,"../data/para1_E1.csv")
...
write.csv(fitI,"../data/para1_I1.csv")
...
write.csv(fitR,"../data/para1_R1.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha1.csv")
