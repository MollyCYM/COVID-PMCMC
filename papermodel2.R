...
write.csv(plot_df,"37wbeta1.csv")
...
write.csv(plot_df1,"37wbeta11.csv")

write.csv(bi_lst$k$value,"37wpalpha1.csv")
write.csv(1/bi_lst$k$value,"37walpha1.csv")
write.csv(bi_lst$gamma$value,"37wpgamma1.csv")
write.csv(1/bi_lst$gamma$value,"37wgamma1.csv")
