...
write.csv(bi_lst,"../data/para1_model12.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y12.csv")
...
write.csv(plot_df,"../data/para1_beta12.csv")
...
write.csv(fitS,"../data/para1_S12.csv")
...
write.csv(fitE,"../data/para1_E12.csv")
...
write.csv(fitI,"../data/para1_I12.csv")
...
write.csv(fitR,"../data/para1_R12.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha12.csv")
write.csv(1/bi_lst$gamma$value,"../data/para1_gamma12.csv")
write.csv(bi_lst$sigma$value,"../data/para1_sigma12.csv")
write.csv(bi_lst$tau$value,"../data/para1_tau12.csv")
