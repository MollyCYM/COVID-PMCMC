...
write.csv(bi_lst, "../data/longdays1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/longdays_y1.csv")
...
write.csv(fitS,"../data/longdays_S1.csv")
...
write.csv(fitE,"../data/longdays_E1.csv")
...
write.csv(fitI,"../data/longdays_I1.csv")
...
write.csv(fitR,"../data/longdays_R1.csv")
...
write.csv(fitM,"../data/longdays_M1.csv")

write.csv(bi_lst$sigma$value,"../data/longdays_sigma1.csv")
write.csv(bi_lst$gamma$value,"../data/longdays_gamma1.csv")
write.csv(bi_lst$beta$value,"../data/longdays_beta1.csv")
write.csv(bi_lst$mu$value,"../data/longdays_mu1.csv")
