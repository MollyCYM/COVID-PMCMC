...
write.csv(bi_lst,"../data/para3_model23.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y23.csv")
...
write.csv(plot_df,"../data/para3_beta23.csv")
...
write.csv(fitS,"../data/para3_S23.csv")
...
write.csv(fitE,"../data/para3_E23.csv")
...
write.csv(fitI,"../data/para3_I23.csv")
...
write.csv(fitR,"../data/para3_R23.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha23.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma23.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma23.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau23.csv")
