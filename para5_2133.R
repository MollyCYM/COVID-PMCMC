...
write.csv(bi_lst,"../data/para5_model2133.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y2133.csv")
...
write.csv(plot_df,"../data/para5_beta2133.csv")
...
write.csv(fitS,"../data/para5_S2133.csv")
...
write.csv(fitE,"../data/para5_E2133.csv")
...
write.csv(fitI,"../data/para5_I2133.csv")
...
write.csv(fitR,"../data/para5_R2133.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha2133.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma2133.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma2133.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta2133.csv")
write.csv(bi_lst$a$value,"../data/para5_a2133.csv")
write.csv(bi_lst$b$value,"../data/para5_b2133.csv")
