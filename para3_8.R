...
write.csv(bi_lst,"../data/para3_model8.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y8.csv")
...
write.csv(plot_df,"../data/para3_beta8.csv")
...
write.csv(fitS,"../data/para3_S8.csv")
...
write.csv(fitE,"../data/para3_E8.csv")
...
write.csv(fitI,"../data/para3_I8.csv")
...
write.csv(fitR,"../data/para3_R8.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha8.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma8.csv")
