...
write.csv(bi_lst,"../data/para5_model312.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y312.csv")
...
write.csv(plot_df,"../data/para5_beta312.csv")
...
write.csv(fitS,"../data/para5_S312.csv")
...
write.csv(fitE,"../data/para5_E312.csv")
...
write.csv(fitI,"../data/para5_I312.csv")
...
write.csv(fitR,"../data/para5_R312.csv")


write.csv(1/bi_lst$k$value,"../data/para5_alpha312.csv")
write.csv(1/bi_lst$gamma$value,"../data/para5_gamma312.csv")
...
write.csv(bi_lst$x0$value,"../data/para5_x0312.csv")
