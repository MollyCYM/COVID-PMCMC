...
write.csv(fitY,"../data/para55_y32.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x32.csv")
...
write.csv(fitS,"../data/para55_S32.csv")
...
write.csv(fitI,"../data/para55_I32.csv")
...
write.csv(fitR,"../data/para55_R32.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik32.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha32.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma32.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma32.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau32.csv")
