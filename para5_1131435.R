...
write.csv(bi_lst,"../data/para5_model1131435.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y1131435.csv")
...
write.csv(plot_df,"../data/para5_beta1131435.csv")
...
write.csv(fitS,"../data/para5_S1131435.csv")
...
write.csv(fitE,"../data/para5_E1131435.csv")
...
write.csv(fitI,"../data/para5_I1131435.csv")
...
write.csv(fitR,"../data/para5_R1131435.csv")


write.csv(bi_lst$a$value,"../data/para5_a1131435.csv")
write.csv(bi_lst$b$value,"../data/para5_b1131435.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau1131435.csv")
