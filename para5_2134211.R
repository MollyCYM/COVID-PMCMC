...
write.csv(bi_lst,"../data/para5_model2134211.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y2134211.csv")
...
write.csv(plot_df,"../data/para5_beta2134211.csv")
...
write.csv(fitS,"../data/para5_S2134211.csv")
...
write.csv(fitE,"../data/para5_E2134211.csv")
...
write.csv(fitI,"../data/para5_I2134211.csv")
...
write.csv(fitR,"../data/para5_R2134211.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha2134211.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma2134211.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma2134211.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta2134211.csv")
write.csv(bi_lst$a$value,"../data/para5_a2134211.csv")
write.csv(bi_lst$b$value,"../data/para5_b2134211.csv")
