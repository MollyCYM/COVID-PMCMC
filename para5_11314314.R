...
write.csv(bi_lst,"../data/para5_model11314314.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y11314314.csv")
...
write.csv(plot_df,"../data/para5_beta11314314.csv")
...
write.csv(fitS,"../data/para5_S11314314.csv")
...
write.csv(fitE,"../data/para5_E11314314.csv")
...
write.csv(fitI,"../data/para5_I11314314.csv")
...
write.csv(fitR,"../data/para5_R11314314.csv")

write.csv(bi_lst$tau$value,"../data/para5_tau11314314.csv")
write.csv(bi_lst$a$value,"../data/para5_a11314314.csv")
write.csv(bi_lst$b$value,"../data/para5_b11314314.csv")
