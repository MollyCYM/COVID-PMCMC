...
write.csv(fitY,"../data/para55_y332.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x332.csv")
...
write.csv(fitS,"../data/para55_S332.csv")
...
write.csv(fitE,"../data/para55_E332.csv")
...
write.csv(fitI,"../data/para55_I332.csv")
...
write.csv(fitR,"../data/para55_R332.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik332.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha332.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma332.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma332.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau332.csv")
