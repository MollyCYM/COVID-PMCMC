...
write.csv(bi_lst,"../data/para1_model7.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y7.csv")
...
write.csv(plot_df,"../data/para1_beta7.csv")
...
write.csv(fitS,"../data/para1_S7.csv")
...
write.csv(fitE,"../data/para1_E7.csv")
...
write.csv(fitI,"../data/para1_I7.csv")
...
write.csv(fitR,"../data/para1_R7.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha7.csv")
write.csv(1/bi_lst$gamma$value,"../data/para1_gamma7.csv")
