...
write.csv(bi_lst,"../data/para5_model31215.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y31215.csv")
...
write.csv(plot_df,"../data/para5_beta31215.csv")
...
write.csv(fitS,"../data/para5_S31215.csv")
...
write.csv(fitE,"../data/para5_E31215.csv")
...
write.csv(fitI,"../data/para5_I31215.csv")
...
write.csv(fitR,"../data/para5_R31215.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha31215.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma31215.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma31215.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta31215.csv")
write.csv(bi_lst$a$value,"../data/para5_a31215.csv")
write.csv(bi_lst$b$value,"../data/para5_b31215.csv")
