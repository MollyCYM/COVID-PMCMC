...
write.csv(fitY,"../data/svminf_y111.csv")

fitalpha <- bi_lst$alpha %>%
  group_by(time) %>%
  ungroup()
write.csv(fitalpha,"../data/svminf_alpha111.csv")
write.csv(bi_lst$loglikelihood$value,"svminf_loglik111.csv")
write.csv(bi_lst$beta$value,"../data/svminf_beta111.csv")
write.csv(bi_lst$phi$value,"../data/svminf_phi111.csv")
write.csv(bi_lst$sigma_eta$value,"../data/svminf_sigma111.csv")