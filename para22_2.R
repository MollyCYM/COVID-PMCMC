...
write.csv(bi_lst,"../data/para22_model2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para22_y2.csv")
...
write.csv(plot_df,"../data/para22_beta2.csv")

Mmodel <- read.csv("Covidou6.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[,4]
E<-Mmodel[,5]
I<-Mmodel[,6]
R<-Mmodel[,7]
...
write.csv(fitS,"../data/para22_S2.csv")
...
write.csv(fitE,"../data/para22_E2.csv")
...
write.csv(fitI,"../data/para22_I2.csv")
...
write.csv(fitR,"../data/para22_R2.csv")

write.csv(1/bi_lst$k$value,"../data/para22_alpha2.csv")
