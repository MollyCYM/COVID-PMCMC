...
init_list <- list(gamma=4, k=6, tau=0.6)
...
write.csv(bi_lst,"../data/init2_model3.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init2_y3.csv")
...
write.csv(plot_df,"../data/init2_beta3.csv")
...
write.csv(plot_df1,"../data/init2_beta03.csv")
...
write.csv(fitS,"../data/init2_S3.csv")
...
write.csv(fitE,"../data/init2_E3.csv")
...
write.csv(fitI,"../data/init2_I3.csv")
...
write.csv(fitR,"../data/init2_R3.csv")


write.csv(1/bi_lst$k$value,"../data/init2_alpha3.csv")
write.csv(1/bi_lst$gamma$value,"../data/init2_gamma3.csv")
