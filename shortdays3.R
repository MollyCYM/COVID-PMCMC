...
write.csv(bi_lst, "../data/short3.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/short_y3.csv")
...
write.csv(fitS,"../data/short_S3.csv")
...
write.csv(fitE,"../data/short_E3.csv")
...
write.csv(fitI,"../data/short_I3.csv")
...
write.csv(fitR,"../data/short_R3.csv")
...
write.csv(fitM,"../data/short_M3.csv")

write.csv(bi_lst$sigma$value,"../data/short_sigma3.csv")
write.csv(bi_lst$gamma$value,"../data/short_gamma3.csv")
write.csv(bi_lst$beta$value,"../data/short_beta3.csv")
write.csv(bi_lst$mu$value,"../data/short_mu3.csv")
