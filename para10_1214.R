...
write.csv(fitY,"../data/para10_y1214.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para10_x1214.csv")

fitS <-bi_lst$S %>%
  group_by(time) %>%
  ungroup()
write.csv(fitS,"../data/para10_S1214.csv")

fitE <-bi_lst$E %>%
  group_by(time) %>%
  ungroup()
write.csv(fitE,"../data/para10_E1214.csv")

fitI <-bi_lst$I %>%
  group_by(time) %>%
  ungroup()
write.csv(fitI,"../data/para10_I1214.csv")

fitR <-bi_lst$R %>%
  group_by(time) %>%
  ungroup() 
write.csv(fitR,"../data/para10_R1214.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para10_loglik1214.csv")
write.csv(bi_lst$k$value,"../data/para10_alpha1214.csv")
write.csv(bi_lst$gamma$value,"../data/para10_gamma1214.csv")
write.csv(bi_lst$sigma$value,"../data/para10_sigma1214.csv")
write.csv(bi_lst$tau$value,"../data/para10_tau1214.csv")
write.csv(bi_lst$theta$value,"../data/para10_theta1214.csv")
write.csv(bi_lst$a$value,"../data/para10_a1214.csv")
write.csv(bi_lst$b$value,"../data/para10_b1214.csv")
