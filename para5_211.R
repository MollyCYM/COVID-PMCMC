...
write.csv(bi_lst,"../data/para5_model211.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y211.csv")
...
write.csv(fitS,"../data/para5_S211.csv")
...
write.csv(fitE,"../data/para5_E211.csv")
...
write.csv(fitI,"../data/para5_I211.csv")
...
write.csv(fitR,"../data/para5_R211.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha211.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma211.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma211.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta211.csv")
write.csv(bi_lst$a$value,"../data/para5_a211.csv")
write.csv(bi_lst$b$value,"../data/para5_b211.csv")
