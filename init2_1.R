...
init_list <- list(gamma=5, k=7, tau=0.8)

bi <- sample(bi_model, end_time = end_time, input = input_lst, input = input_lst, obs = obs_lst, nsamples = 1000, nparticles = minParticles, nthreads = ncores, proposal = 'prior',seed=0123112) %>% 
...
write.csv(bi_lst,"../data/init2_model1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init2_y1.csv")
...
write.csv(plot_df,"../data/init2_beta1.csv")
...
write.csv(plot_df1,"../data/init2_beta01.csv")
...
write.csv(fitS,"../data/init2_S1.csv")
...
write.csv(fitE,"../data/init2_E1.csv")
...
write.csv(fitI,"../data/init2_I1.csv")
...
write.csv(fitR,"../data/init2_R1.csv")


write.csv(1/bi_lst$k$value,"../data/init2_alpha1.csv")
write.csv(1/bi_lst$gamma$value,"../data/init2_gamma1.csv")
