...
particles_adapted <- bi_model %>%
  ...
  adapt_particles(min = minParticles, max = 10000)
...
write.csv(fitY,"../data/para55_y341.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x341.csv")
...
write.csv(fitS,"../data/para55_S341.csv")
...
write.csv(fitE,"../data/para55_E341.csv")
...
write.csv(fitI,"../data/para55_I341.csv")
...
write.csv(fitR,"../data/para55_R341.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik341.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha341.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma341.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma341.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau341.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta341.csv")
write.csv(bi_lst$a$value,"../data/para55_a341.csv")
write.csv(bi_lst$b$value,"../data/para55_b341.csv")
