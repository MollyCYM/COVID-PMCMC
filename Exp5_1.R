...
write.csv(bi_lst,"../data/Exp5_model2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp5_y2.csv")
...
write.csv(plot_df,"../data/Exp5_beta2.csv")
...
write.csv(plot_df1,"../data/Exp5_beta02.csv")
...
write.csv(fitS,"../data/Exp5_S2.csv")
...
write.csv(fitE,"../data/Exp5_E2.csv")
...
write.csv(fitI,"../data/Exp5_I2.csv")
...
write.csv(fitR,"../data/Exp5_R2.csv")


write.csv(1/bi_lst$k$value,"../data/Exp5_alpha2.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp5_gamma2.csv")
