...
model dureau {
  ...
  sub proposal_parameter {
    ...
    sigma ~ truncated_gaussian(sigma, 0.001, lower = 0,upper=0.1)
    tau ~ truncated_gaussian(tau, 0.001,lower = 0,upper=0.2)
  }
...
write.csv(fitY,"../data/para55_y33.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x33.csv")
...
write.csv(fitS,"../data/para55_S33.csv")
...
write.csv(fitE,"../data/para55_E33.csv")
...
write.csv(fitI,"../data/para55_I33.csv")
...
write.csv(fitR,"../data/para55_R33.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik33.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha33.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma33.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma33.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau33.csv")
