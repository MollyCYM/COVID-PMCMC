...
bi <- sample(bi_model, end_time = end_time, input = input_lst, input = input_lst, obs = obs_lst, nsamples = 1000, nparticles = minParticles, nthreads = ncores, proposal = 'model',seed=0123112) %>% 
...
write.csv(bi_lst,"../data/init2_model2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init2_y2.csv")
...
write.csv(plot_df,"../data/init2_beta2.csv")
...
write.csv(plot_df1,"../data/init2_beta02.csv")
...
write.csv(fitS,"../data/init2_S2.csv")
...
write.csv(fitE,"../data/init2_E2.csv")
...
write.csv(fitI,"../data/init2_I2.csv")
...
write.csv(fitR,"../data/init2_R2.csv")


write.csv(1/bi_lst$k$value,"../data/init2_alpha2.csv")
write.csv(1/bi_lst$gamma$value,"../data/init2_gamma2.csv")
