...
write.csv(fitY,"../data/para55_y11.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x11.csv")
...
write.csv(fitS,"../data/para55_S11.csv")
...
write.csv(fitE,"../data/para55_E11.csv")
...
write.csv(fitI,"../data/para55_I11.csv")
...
write.csv(fitR,"../data/para55_R11.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik11.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha11.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma11.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma11.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau11.csv")
