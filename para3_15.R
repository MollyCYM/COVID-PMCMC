...
write.csv(bi_lst,"../data/para3_model15.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y15.csv")
...
write.csv(plot_df,"../data/para3_beta15.csv")
...
write.csv(fitS,"../data/para3_S15.csv")
...
write.csv(fitE,"../data/para3_E15.csv")
...
write.csv(fitI,"../data/para3_I15.csv")
...
write.csv(fitR,"../data/para3_R15.csv")
