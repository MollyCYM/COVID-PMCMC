...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg_y3w.csv", header=FALSE, stringsAsFactors=FALSE) %>%
  rowSums()
...
write.csv(bi_lst,"../data/para5_model311.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y311.csv")
...
write.csv(plot_df,"../data/para5_beta311.csv")

Mmodel <- read.csv("covidoudg_model3.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[,4]
E<-Mmodel[,5]
I<-Mmodel[,6]
R<-Mmodel[,7]
...
write.csv(fitS,"../data/para5_S311.csv")
...
write.csv(fitE,"../data/para5_E311.csv")
...
write.csv(fitI,"../data/para5_I311.csv")
...
write.csv(fitR,"../data/para5_R311.csv")


write.csv(1/bi_lst$k$value,"../data/para5_alpha311.csv")
write.csv(1/bi_lst$gamma$value,"../data/para5_gamma311.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma311.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau311.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta311.csv")
write.csv(bi_lst$a$value,"../data/para5_a311.csv")
write.csv(bi_lst$b$value,"../data/para5_b311.csv")
write.csv(bi_lst$x0$value,"../data/para5_x0311.csv")
