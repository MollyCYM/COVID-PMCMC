...
write.csv(fitY,"../data/para6_y1.csv")
...
write.csv(plot_df,"../data/para6_beta1.csv")
...
write.csv(fitS,"../data/para6_S1.csv")
...
write.csv(fitE,"../data/para6_E1.csv")
...
write.csv(fitI,"../data/para6_I1.csv")
...
write.csv(fitR,"../data/para6_R1.csv")
