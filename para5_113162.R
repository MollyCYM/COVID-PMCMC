...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg2_y132w.csv", header=FALSE, stringsAsFactors=FALSE) %>%
  rowSums()
...
write.csv(bi_lst,"../data/para5_model113162.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y113162.csv")
...
write.csv(plot_df,"../data/para5_beta113162.csv")

Mmodel <- read.csv("covidoudg2_model1232.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[-1,7]
E<-Mmodel[-1,9]
I<-Mmodel[-1,11]
R<-Mmodel[-1,13]
...
write.csv(fitS,"../data/para5_S113162.csv")
...
write.csv(fitE,"../data/para5_E113162.csv")
...
write.csv(fitI,"../data/para5_I113162.csv")
...
write.csv(fitR,"../data/para5_R113162.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha113162.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma113162.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma113162.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta113162.csv")
write.csv(bi_lst$b$value,"../data/para5_b113162.csv")
