...
write.csv(bi_lst,"../data/para1_model13.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y13.csv")
...
write.csv(plot_df,"../data/para1_beta13.csv")
...
write.csv(fitS,"../data/para1_S13.csv")
...
write.csv(fitE,"../data/para1_E13.csv")
...
write.csv(fitI,"../data/para1_I13.csv")
...
write.csv(fitR,"../data/para1_R13.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha13.csv")
write.csv(1/bi_lst$gamma$value,"../data/para1_gamma13.csv")
write.csv(bi_lst$sigma$value,"../data/para1_sigma13.csv")
write.csv(bi_lst$tau$value,"../data/para1_tau13.csv")
