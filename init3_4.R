...
init_list <- list(sigma=sqrt(0.003), gamma=3, k=3, theta=0.04, tau=0.6)
...
write.csv(bi_lst,"../data/init3_model4.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/init3_y4.csv")
...
write.csv(plot_df,"../data/init3_beta4.csv")
...
write.csv(plot_df1,"../data/init3_beta04.csv")
...
write.csv(fitmu,"../data/init3_mu4.csv")
...
write.csv(fitS,"../data/init3_S4.csv")
...
write.csv(fitE,"../data/init3_E4.csv")
...
write.csv(fitI,"../data/init3_I4.csv")
...
write.csv(fitR,"../data/init3_R4.csv")

write.csv(1/bi_lst$k$value,"../data/init3_alpha4.csv")
write.csv(1/bi_lst$gamma$value,"../data/init3_gamma4.csv")
write.csv(bi_lst$sigma$value,"../data/init3_sigma4.csv")
write.csv(bi_lst$theta$value,"../data/init3_theta4.csv")
