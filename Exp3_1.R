...
write.csv(bi_lst,"../data/Exp3_model1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp3_y1.csv")
...
write.csv(plot_df,"../data/Exp3_beta1.csv")
...
write.csv(plot_df1,"../data/Exp3_beta01.csv")
...
write.csv(fitmu,"../data/Exp3_mu1.csv")
...
write.csv(fitS,"../data/Exp3_S1.csv")
...
write.csv(fitE,"../data/Exp3_E1.csv")
...
write.csv(fitI,"../data/Exp3_I1.csv")
...
write.csv(fitR,"../data/Exp3_R1.csv")

write.csv(1/bi_lst$k$value,"../data/Exp3_alpha1.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp3_gamma1.csv")
write.csv(bi_lst$sigma$value,"../data/Exp3_sigma1.csv")
write.csv(bi_lst$theta$value,"../data/Exp3_theta1.csv")
