...
bi <- sample(bi_model, end_time = end_time, input = input_lst, obs = obs_lst, nsamples = 1000, nparticles = minParticles, nthreads = ncores, proposal = 'model',seed=01212) %>% 
...
write.csv(bi_lst,"../data/Exp3_model7.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp3_y7.csv")
...
write.csv(plot_df,"../data/Exp3_beta7.csv")
...
write.csv(plot_df1,"../data/Exp3_beta07.csv")
...
write.csv(fitmu,"../data/Exp3_mu7.csv")
...
write.csv(fitS,"../data/Exp3_S7.csv")
...
write.csv(fitE,"../data/Exp3_E7.csv")
...
write.csv(fitI,"../data/Exp3_I7.csv")
...
write.csv(fitR,"../data/Exp3_R7.csv")

write.csv(1/bi_lst$k$value,"../data/Exp3_alpha7.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp3_gamma7.csv")
write.csv(bi_lst$sigma$value,"../data/Exp3_sigma7.csv")
write.csv(bi_lst$theta$value,"../data/Exp3_theta7.csv")
