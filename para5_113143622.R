...
write.csv(bi_lst,"../data/para5_model113143622.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y113143622.csv")
...
write.csv(plot_df,"../data/para5_beta113143622.csv")
...
write.csv(fitS,"../data/para5_S113143622.csv")
...
write.csv(fitE,"../data/para5_E113143622.csv")
...
write.csv(fitI,"../data/para5_I113143622.csv")
...
write.csv(fitR,"../data/para5_R113143622.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha113143622.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma113143622.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma113143622.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau113143622.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta113143622.csv")
write.csv(bi_lst$a$value,"../data/para5_a113143622.csv")
write.csv(bi_lst$b$value,"../data/para5_b113143622.csv")
