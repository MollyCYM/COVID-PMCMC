...
library(readr)
# Load the data
v <- read.csv("800days.csv", header=FALSE, stringsAsFactors=FALSE) 
...
write.csv(bi_lst, "../data/longdays2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/longdays_y2.csv")
...
write.csv(fitS,"../data/longdays_S2.csv")
...
write.csv(fitE,"../data/longdays_E2.csv")
...
write.csv(fitI,"../data/longdays_I2.csv")
...
write.csv(fitR,"../data/longdays_R2.csv")
...
write.csv(fitM,"../data/longdays_M2.csv")

write.csv(bi_lst$sigma$value,"../data/longdays_sigma2.csv")
write.csv(bi_lst$gamma$value,"../data/longdays_gamma2.csv")
write.csv(bi_lst$beta$value,"../data/longdays_beta2.csv")
write.csv(bi_lst$mu$value,"../data/longdays_mu2.csv")
