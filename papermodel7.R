...
write.csv(plot_df,"37wbeta6.csv")
...
write.csv(plot_df1,"37wbeta16.csv")

write.csv(bi_lst$k$value,"37wpalpha6.csv")
write.csv(1/bi_lst$k$value,"37walpha6.csv")
write.csv(bi_lst$gamma$value,"37wpgamma6.csv")
write.csv(1/bi_lst$gamma$value,"37wgamma6.csv")
