...
init_list <- list(tau=0.1,a=-0.02,b=-0.2)
#LibBi wrapper 
...
write.csv(bi_lst,"../data/para5_model1131438.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y1131438.csv")
...
write.csv(plot_df,"../data/para5_beta1131438.csv")
...
write.csv(fitS,"../data/para5_S1131438.csv")
...
write.csv(fitE,"../data/para5_E1131438.csv")
...
write.csv(fitI,"../data/para5_I1131438.csv")
...
write.csv(fitR,"../data/para5_R1131438.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha1131438.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma1131438.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma1131438.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau1131438.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta1131438.csv")
write.csv(bi_lst$a$value,"../data/para5_a1131438.csv")
write.csv(bi_lst$b$value,"../data/para5_b1131438.csv")
