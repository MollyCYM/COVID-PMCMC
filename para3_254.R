...
write.csv(bi_lst,"../data/para3_model254.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y254.csv")
...
write.csv(plot_df,"../data/para3_beta254.csv")
...
write.csv(fitS,"../data/para3_S254.csv")
...
write.csv(fitE,"../data/para3_E254.csv")
...
write.csv(fitI,"../data/para3_I254.csv")
...
write.csv(fitR,"../data/para3_R254.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha254.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma254.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma254.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau254.csv")
