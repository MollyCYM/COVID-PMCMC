...
write.csv(bi_lst,"../data/para5_model3.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y3.csv")
...
write.csv(plot_df,"../data/para5_beta3.csv")
...
write.csv(fitS,"../data/para5_S3.csv")
...
write.csv(fitE,"../data/para5_E3.csv")
...
write.csv(fitI,"../data/para5_I3.csv")
...
write.csv(fitR,"../data/para5_R3.csv")


write.csv(1/bi_lst$k$value,"../data/para5_alpha3.csv")
write.csv(1/bi_lst$gamma$value,"../data/para5_gamma3.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma3.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau3.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta3.csv")
write.csv(bi_lst$a$value,"../data/para5_a3.csv")
write.csv(bi_lst$b$value,"../data/para5_b3.csv")
