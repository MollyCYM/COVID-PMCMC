...
model dureau {
  ...
  sub proposal_parameter {
    k ~ truncated_gaussian(k, 0.05, lower = 0) 
...
write.csv(bi_lst,"../data/para5_model113128.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y113128.csv")
...
write.csv(plot_df,"../data/para5_beta113128.csv")
...
write.csv(fitS,"../data/para5_S113128.csv")
...
write.csv(fitE,"../data/para5_E113128.csv")
...
write.csv(fitI,"../data/para5_I113128.csv")
...
write.csv(fitR,"../data/para5_R113128.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha113128.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma113128.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma113128.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau113128.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta113128.csv")
write.csv(bi_lst$a$value,"../data/para5_a113128.csv")
write.csv(bi_lst$b$value,"../data/para5_b113128.csv")
