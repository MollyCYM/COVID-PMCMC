...
write.csv(bi_lst,"../data/Exp1_model2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp1_y2.csv")
...
write.csv(plot_df,"../data/Exp1_beta2.csv")
...
write.csv(plot_df1,"../data/Exp1_beta02.csv")
...
write.csv(fitS,"../data/Exp1_S2.csv")
...
write.csv(fitE,"../data/Exp1_E2.csv")
...
write.csv(fitI,"../data/Exp1_I2.csv")
...
write.csv(fitR,"../data/Exp1_R2.csv")


write.csv(1/bi_lst$k$value,"../data/Exp1_alpha2.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp1_gamma2.csv")
