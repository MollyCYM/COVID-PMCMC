...
library(rbi.helpers)
# Load the data
v <- read.csv("rsimcovidou_wk1.csv", header=FALSE, stringsAsFactors=FALSE) %>%
  rowSums()
...
write.csv(bi_lst,"../data/para2_model4.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para2_y4.csv")
...
write.csv(plot_df,"../data/para2_beta4.csv")
...
write.csv(fitS,"../data/para2_S4.csv")
...
write.csv(fitE,"../data/para2_E4.csv")
...
write.csv(fitI,"../data/para2_I4.csv")
...
write.csv(fitR,"../data/para2_R4.csv")


write.csv(1/bi_lst$k$value,"../data/para2_alpha4.csv")
write.csv(1/bi_lst$gamma$value,"../data/para2_gamma4.csv")
write.csv(bi_lst$sigma$value,"../data/para2_sigma4.csv")
write.csv(bi_lst$tau$value,"../data/para2_tau4.csv")
write.csv(bi_lst$theta$value,"../data/para2_theta4.csv")
write.csv(bi_lst$a$value,"../data/para2_a4.csv")
write.csv(bi_lst$b$value,"../data/para2_b4.csv")
