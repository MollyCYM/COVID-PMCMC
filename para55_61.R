...
write.csv(fitY,"../data/para55_y61.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x61.csv")
...
write.csv(fitS,"../data/para55_S61.csv")
...
write.csv(fitE,"../data/para55_E61.csv")
...
write.csv(fitI,"../data/para55_I61.csv")
...
write.csv(fitR,"../data/para55_R61.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik61.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha61.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma61.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma61.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta61.csv")
write.csv(bi_lst$a$value,"../data/para55_a61.csv")
write.csv(bi_lst$b$value,"../data/para55_b61.csv")
