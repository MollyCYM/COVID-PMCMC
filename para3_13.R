...
write.csv(bi_lst,"../data/para3_model13.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y13.csv")
...
write.csv(plot_df,"../data/para3_beta13.csv")
...
write.csv(fitS,"../data/para3_S13.csv")
...
write.csv(fitE,"../data/para3_E13.csv")
...
write.csv(fitI,"../data/para3_I13.csv")
...
write.csv(fitR,"../data/para3_R13.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha13.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma13.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma13.csv")
