...
write.csv(bi_lst,"../data/para3_model4.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y4.csv")
...
write.csv(plot_df,"../data/para3_beta4.csv")
...
write.csv(fitS,"../data/para3_S4.csv")
...
write.csv(fitE,"../data/para3_E4.csv")
...
write.csv(fitI,"../data/para3_I4.csv")
...
write.csv(fitR,"../data/para3_R4.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha4.csv")
