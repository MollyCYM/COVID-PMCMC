...
write.csv(bi_lst,"../data/para5_model31212.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y31212.csv")
...
write.csv(plot_df,"../data/para5_beta31212.csv")
...
write.csv(fitS,"../data/para5_S31212.csv")
...
write.csv(fitE,"../data/para5_E31212.csv")
...
write.csv(fitI,"../data/para5_I31212.csv")
...
write.csv(fitR,"../data/para5_R31212.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha31212.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma31212.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma31212.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta31212.csv")
write.csv(bi_lst$a$value,"../data/para5_a31212.csv")
write.csv(bi_lst$b$value,"../data/para5_b31212.csv")
