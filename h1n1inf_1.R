...
model h1n1bm {
  ...
  sub parameter {
    ...
    gamma ~ truncated_gaussian(5, 2, lower = 0) // gamma is the period, not the rate
...
#Data save command
write.csv(bi_lst,"../data/h1n1inf_model1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/h1n1inf_y1.csv")
...
write.csv(plot_df,"../data/h1n1inf_beta1.csv")
...
write.csv(fitS,"../data/h1n1inf_S1.csv")
...
write.csv(fitE,"../data/h1n1inf_E1.csv")
...
write.csv(fitI,"../data/h1n1inf_I1.csv")
...
write.csv(fitR,"../data/h1n1inf_R1.csv")


write.csv(bi_lst$k$value,"../data/h1n1inf_alpha1.csv")
write.csv(bi_lst$gamma$value,"../data/h1n1inf_gamma1.csv")
write.csv(bi_lst$sigma$value,"../data/h1n1inf_sigma1.csv")
write.csv(bi_lst$tau$value,"../data/h1n1inf_tau1.csv")
