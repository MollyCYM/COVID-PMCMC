...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg2_y321d.csv", header=FALSE, stringsAsFactors=FALSE) 
...
write.csv(bi_lst,"../data/para5_model21342111.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y21342111.csv")
...
write.csv(plot_df,"../data/para5_beta21342111.csv")
...
write.csv(fitS,"../data/para5_S21342111.csv")
...
write.csv(fitE,"../data/para5_E21342111.csv")
...
write.csv(fitI,"../data/para5_I21342111.csv")
...
write.csv(fitR,"../data/para5_R21342111.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha21342111.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma21342111.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma213421111.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta21342111.csv")
write.csv(bi_lst$a$value,"../data/para5_a21342111.csv")
write.csv(bi_lst$b$value,"../data/para5_b21342111.csv")
