...
write.csv(bi_lst,"../data/Exp4_model2.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/Exp4_y2.csv")
...
write.csv(plot_df,"../data/Exp4_beta2.csv")
...
write.csv(plot_df1,"../data/Exp4_beta02.csv")
...
write.csv(fitS,"../data/Exp4_S2.csv")
...
write.csv(fitE,"../data/Exp4_E2.csv")
...
write.csv(fitI,"../data/Exp4_I2.csv")
...
write.csv(fitR,"../data/Exp4_R2.csv")


write.csv(1/bi_lst$k$value,"../data/Exp4_alpha2.csv")
write.csv(1/bi_lst$gamma$value,"../data/Exp4_gamma2.csv")
