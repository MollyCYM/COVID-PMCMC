...
write.csv(fitY,"../data/para55_y22.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x22.csv")
...
write.csv(fitS,"../data/para55_S22.csv")
...
write.csv(fitE,"../data/para55_E22.csv")
...
write.csv(fitI,"../data/para55_I22.csv")
...
write.csv(fitR,"../data/para55_R22.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik22.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha22.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma22.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma22.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau22.csv")
