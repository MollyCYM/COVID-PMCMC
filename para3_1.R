...
library(rbi.helpers)
# Load the data
v <- read.csv("h1n1bm_wk1.csv", header=FALSE, stringsAsFactors=FALSE) %>%
  rowSums()
...
write.csv(bi_lst,"../data/para3_model1.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y1.csv")
...
write.csv(plot_df,"../data/para3_beta1.csv")

Mmodel <- read.csv("simulatestates21.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[,4]
E<-Mmodel[,5]
I<-Mmodel[,6]
R<-Mmodel[,7]
...
write.csv(fitS,"../data/para3_S1.csv")
...
write.csv(fitE,"../data/para3_E1.csv")
...
write.csv(fitI,"../data/para3_I1.csv")
...
write.csv(fitR,"../data/para3_R1.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha1.csv")
