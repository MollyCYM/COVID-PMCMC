...
write.csv(bi_lst,"../data/para1_model4.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y4.csv")
...
write.csv(plot_df,"../data/para1_beta4.csv")
...
write.csv(fitS,"../data/para1_S4.csv")
...
write.csv(fitE,"../data/para1_E4.csv")
...
write.csv(fitI,"../data/para1_I4.csv")
...
write.csv(fitR,"../data/para1_R4.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha4.csv")
write.csv(1/bi_lst$gamma$value,"../data/para1_gamma4.csv")
