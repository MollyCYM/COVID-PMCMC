...
write.csv(bi_lst,"../data/para1_model6.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para1_y6.csv")
...
write.csv(plot_df,"../data/para1_beta6.csv")
...
write.csv(fitS,"../data/para1_S6.csv")
...
write.csv(fitE,"../data/para1_E6.csv")
...
write.csv(fitI,"../data/para1_I6.csv")
...
write.csv(fitR,"../data/para1_R6.csv")

write.csv(1/bi_lst$k$value,"../data/para1_alpha6.csv")
write.csv(1/bi_lst$gamma$value,"../data/para1_gamma6.csv")
