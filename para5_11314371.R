...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg2_y1211d.csv", header=FALSE, stringsAsFactors=FALSE) 
...
model dureau {
  ...
  sub parameter {
    ...
    sigma ~ truncated_gaussian(sqrt(0.004)/10, 0.1, lower = 0)
    theta ~ truncated_gaussian(0.2, 0.8, lower = 0)
  ...
  sub proposal_parameter {
    ...
    gamma ~ truncated_gaussian(gamma, 0.05, lower = 0) 
...
init_list <- list(k=5, gamma=9, sigma=sqrt(0.004)/10,theta=0.2,tau=0.1,a=-0.02,b=-0.2)
#LibBi wrapper 
...
write.csv(bi_lst,"../data/para5_model11314371.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y11314371.csv")
...
write.csv(plot_df,"../data/para5_beta11314371.csv")

Mmodel <- read.csv("covidoudg2_model1211.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[-1,7]
E<-Mmodel[-1,9]
I<-Mmodel[-1,11]
R<-Mmodel[-1,13]
...
write.csv(fitS,"../data/para5_S11314371.csv")
...
write.csv(fitE,"../data/para5_E11314371.csv")
...
write.csv(fitI,"../data/para5_I11314371.csv")
...
write.csv(fitR,"../data/para5_R11314371.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha11314371.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma11314371.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma11314371.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau11314371.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta11314371.csv")
write.csv(bi_lst$a$value,"../data/para5_a11314371.csv")
write.csv(bi_lst$b$value,"../data/para5_b11314371.csv")
