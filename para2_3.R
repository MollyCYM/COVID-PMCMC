...
write.csv(bi_lst,"../data/para2_model3.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para2_y3.csv")
...
write.csv(plot_df,"../data/para2_beta3.csv")
...
write.csv(fitS,"../data/para2_S3.csv")
...
write.csv(fitE,"../data/para2_E3.csv")
...
write.csv(fitI,"../data/para2_I3.csv")
...
write.csv(fitR,"../data/para2_R3.csv")

write.csv(1/bi_lst$k$value,"../data/para2_alpha3.csv")
write.csv(1/bi_lst$gamma$value,"../data/para2_gamma3.csv")
