...
write.csv(bi_lst,"../data/para3_model19.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y19.csv")
...
write.csv(plot_df,"../data/para3_beta19.csv")
...
write.csv(fitS,"../data/para3_S19.csv")
...
write.csv(fitE,"../data/para3_E19.csv")
...
write.csv(fitI,"../data/para3_I19.csv")
...
write.csv(fitR,"../data/para3_R19.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha19.csv")
