...
write.csv(bi_lst,"../data/para10_model12.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para10_y12.csv")
...
write.csv(plot_df,"../data/para10_beta12.csv")
...
write.csv(fitS,"../data/para10_S12.csv")
...
write.csv(fitE,"../data/para10_E12.csv")
...
write.csv(fitI,"../data/para10_I12.csv")
...
write.csv(fitR,"../data/para10_R12.csv")


write.csv(bi_lst$k$value,"../data/para10_alpha12.csv")
write.csv(bi_lst$gamma$value,"../data/para10_gamma12.csv")
write.csv(bi_lst$sigma$value,"../data/para10_sigma12.csv")
write.csv(bi_lst$tau$value,"../data/para10_tau12.csv")
write.csv(bi_lst$theta$value,"../data/para10_theta12.csv")
write.csv(bi_lst$a$value,"../data/para10_a12.csv")
write.csv(bi_lst$b$value,"../data/para10_b12.csv")
