...
write.csv(fitY,"../data/para55_y52.csv")

plot_df <- bi_lst$x  %>%
  group_by(time) 
write.csv(plot_df,"../data/para55_x52.csv")
...
write.csv(fitS,"../data/para55_S52.csv")
...
write.csv(fitE,"../data/para55_E52.csv")
...
write.csv(fitI,"../data/para55_I52.csv")
...
write.csv(fitR,"../data/para55_R52.csv")

write.csv(bi_lst$loglikelihood$value,"../data/para55_loglik52.csv")
write.csv(bi_lst$k$value,"../data/para55_alpha52.csv")
write.csv(bi_lst$gamma$value,"../data/para55_gamma52.csv")
write.csv(bi_lst$sigma$value,"../data/para55_sigma52.csv")
write.csv(bi_lst$tau$value,"../data/para55_tau52.csv")
write.csv(bi_lst$theta$value,"../data/para55_theta52.csv")
write.csv(bi_lst$a$value,"../data/para55_a52.csv")
write.csv(bi_lst$b$value,"../data/para55_b52.csv")
