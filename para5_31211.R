...
library(rbi.helpers)
# Load the data
v <- read.csv("covidoudg2_y221w.csv", header=FALSE, stringsAsFactors=FALSE) %>%
  rowSums()
...
write.csv(bi_lst,"../data/para5_model31211.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y31211.csv")
...
write.csv(plot_df,"../data/para5_beta31211.csv")

Mmodel <- read.csv("covidoudg2_model221.csv", header=TRUE, stringsAsFactors=FALSE)
S<-Mmodel[-1,7]
E<-Mmodel[-1,9]
I<-Mmodel[-1,11]
R<-Mmodel[-1,13]
...
write.csv(fitS,"../data/para5_S31211.csv")
...
write.csv(fitE,"../data/para5_E31211.csv")
...
write.csv(fitI,"../data/para5_I31211.csv")
...
write.csv(fitR,"../data/para5_R31211.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha31211.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma31211.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma31211.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta31211.csv")
write.csv(bi_lst$a$value,"../data/para5_a31211.csv")
write.csv(bi_lst$b$value,"../data/para5_b31211.csv")
