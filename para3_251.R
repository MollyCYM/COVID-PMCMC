...
write.csv(bi_lst,"../data/para3_model251.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para3_y251.csv")
...
write.csv(plot_df,"../data/para3_beta251.csv")
...
write.csv(fitS,"../data/para3_S251.csv")
...
write.csv(fitE,"../data/para3_E251.csv")
...
write.csv(fitI,"../data/para3_I251.csv")
...
write.csv(fitR,"../data/para3_R251.csv")


write.csv(1/bi_lst$k$value,"../data/para3_alpha251.csv")
write.csv(1/bi_lst$gamma$value,"../data/para3_gamma251.csv")
write.csv(bi_lst$sigma$value,"../data/para3_sigma251.csv")
write.csv(bi_lst$tau$value,"../data/para3_tau251.csv")
write.csv(bi_lst$E0$value,"../data/para3_E0251.csv")
write.csv(bi_lst$I0$value,"../data/para3_I0251.csv")
write.csv(bi_lst$R0$value,"../data/para3_R0251.csv")
