...
write.csv(bi_lst,"../data/para5_model1133.csv")
fitY <- bi_lst$y %>%
  group_by(time) %>%
  mutate(
...
write.csv(fitY,"../data/para5_y1133.csv")
...
write.csv(plot_df,"../data/para5_beta1133.csv")
...
write.csv(fitS,"../data/para5_S1133.csv")
...
write.csv(fitE,"../data/para5_E1133.csv")
...
write.csv(fitI,"../data/para5_I1133.csv")
...
write.csv(fitR,"../data/para5_R1133.csv")


write.csv(bi_lst$k$value,"../data/para5_alpha1133.csv")
write.csv(bi_lst$gamma$value,"../data/para5_gamma1133.csv")
write.csv(bi_lst$sigma$value,"../data/para5_sigma1133.csv")
write.csv(bi_lst$tau$value,"../data/para5_tau1133.csv")
write.csv(bi_lst$theta$value,"../data/para5_theta1133.csv")
write.csv(bi_lst$a$value,"../data/para5_a1133.csv")
write.csv(bi_lst$b$value,"../data/para5_b1133.csv")
